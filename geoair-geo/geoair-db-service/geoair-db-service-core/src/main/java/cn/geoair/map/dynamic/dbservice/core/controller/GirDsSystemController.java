...
public class GirDsSystemController {
	...
	public String login(@RequestParam String username, @RequestParam String password) {
		...
		if (enableLogin) {
			...
			String token = TokenManager.generateToken(girDsServiceProperties.getDefaultUser(),
	...
	public Map<String, Object> context(HttpServletRequest request) {
		...
		config.put("byCurrentContextPath", ServletUriComponentsBuilder.fromCurrentContextPath().build().toUriString());
