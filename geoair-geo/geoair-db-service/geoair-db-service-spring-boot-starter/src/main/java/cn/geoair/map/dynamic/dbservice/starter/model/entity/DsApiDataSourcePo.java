package cn.geoair.map.dynamic.dbservice.starter.model.entity;
 ...
 */
@GaModel(text = "数据源信息")
@Table(name = "dsapi_datasource")
public class DsApiDataSourcePo implements GiCrudEntity<String>, GiEntityIdGenerator<String> {
	...
	public DsApiDataSourcePo(String id) {
		if (id == null) {
			id = this.generatorId();
		}
		this.id = id;
	...
	public static DsApiDataSourcePo empty() {
		return new DsApiDataSourcePo();
	}

	public DsApiDataSourcePo copy() {
		DsApiDataSourcePo copy = new DsApiDataSourcePo();
