...
// */
// public class PgAdvSimplePagePreOpt extends PgAdvSimplePageOpt implements
...
// validateFullPageParams(noPageSqlStatement, pageNum, pageSize, pageNumStartZero,
// orders);
// if (sqlParam == null) {
...
// // 3.1 提取所有字段名（去重）
// List<String> fieldNames = dataFieldsApo.getFieldList(FieldBySchemaApo::getColumnName,
// true);
// // 3.2 识别空间字段（用于后续空间操作）
...
//
// // 7. 执行带参数的分页查询（处理空间字段）
// List<GirAdvOneRow> records = pgAdvGeoPreOpt.eSelectList(pageSql, sqlParam,
// advEnumsGeomOpt, geomFieldNameList);
//
// // 8. 构建分页结果对象
// PageApo<GirAdvOneRow> pageApo = createPageApo(total, pageNum, pageSize,
// pageNumStartZero, lastPageNum, offset, records);
//
// // 9. 组装字段元数据（如果需要）
// if (hasFieldsInfo) {
...
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
// pageNum, int pageSize) {
// return pPage(noPageSqlStatement, sqlParam, pageNum, pageSize, false, 不做任何操作, false,
// ListUtil.empty());
// }
//
// @Override
...
// return pPage(noPageSqlStatement, sqlParam, pageNum, pageSize, false, advEnumsGeomOpt,
// false, ListUtil.empty());
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
...
// return pPage(noPageSqlStatement, sqlParam, pageNum, pageSize, pageNumStartZero, 不做任何操作,
// hasFieldsInfo, ListUtil.empty());
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
...
// return pPage(noPageSqlStatement, sqlParam, pageNum, pageSize, pageNumStartZero,
// advEnumsGeomOpt, hasFieldsInfo, ListUtil.empty());
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
...
// pageNum, int pageSize, boolean pageNumStartZero, AdvEnumsGeomOpt advEnumsGeomOpt) {
// return pPage(noPageSqlStatement, sqlParam, pageNum, pageSize, pageNumStartZero,
// advEnumsGeomOpt, false, ListUtil.empty());
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
