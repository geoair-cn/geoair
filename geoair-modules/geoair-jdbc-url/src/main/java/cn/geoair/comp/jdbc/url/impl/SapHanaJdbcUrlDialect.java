 ...
 *
 * <p>遵循项目原有格式 {@code jdbc:sap://host:port/?databaseName=db}；数据库名位于查询参数而不是路径。</p>
 *
 * @author 张逢吉
 */
public class SapHanaJdbcUrlDialect implements JdbcUrlDialect {
    @Override public DatabaseType getDatabaseType() { return DatabaseType.SAP_HANA; }
    @Override public String getSchemaPropertyName() { return null; }
    @Override public boolean supports(String jdbcUrl) { return jdbcUrl.regionMatches(true, 0, "jdbc:sap://", 0, 11); }
    ...
    public JdbcUrl parse(String jdbcUrl) {
        ...
        return new JdbcUrl(jdbcUrl, DatabaseType.SAP_HANA, "sap", null, tail.coreUrl,
    ...
    public JdbcUrl create(String host, Integer port, String databaseName) {
        ...
        return new JdbcUrl(core, DatabaseType.SAP_HANA, "sap", null, core,
