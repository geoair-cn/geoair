...
public class MVTTileTest {
    public static void main(String[] args) {
        ...
        context.setDataId("MVT_TILES").setMapTileType(GirMapTileType.MVT_TILES).setStorageType(GirStorageType.LOCAL_ZIP).setObjectKey("E:\\gis测试数据\\测试数据\\MVT\\hgt_mapbox.zip");
