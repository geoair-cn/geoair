...
/** @author ：张俊 &#064;date ：Created in 2025/11/17 17:42 &#064;description： 配置属性类 */
@Data
...
public class GirS3ConfigProperties {
    ...
    /**
     * S3 服务终端节点 (Endpoint) 例如: http://localhost:9000 (MinIO), https://oss-cn-beijing.aliyuncs.com
     * (阿里云OSS) 如果为空，则使用标准 AWS S3 端点
     */
    private String endpoint;

    /**
     * S3 服务域名 例如: http://localhost:9000 (MinIO), https://oss-cn-beijing.aliyuncs.com (阿里云OSS)
     * 如果为空，则使用标准 AWS S3 域名
     */
    private String domain;

    /** S3 服务区域 (Region) 例如: us-east-1, cn-north-1 */
