...
public class GirForgeServletAutoConfiguration {
    ...
    private static final GiLogger log = GirLoggerFactory.getLogger(GirForgeServletAutoConfiguration.class);


    private GirMapTileService getRequiredService(ObjectProvider<GirMapTileService> provider, String servletName) {
    ...
    private <T> T createServlet(ObjectProvider<GirMapTileService> provider,
                                String servletName,
