...
import cn.geoair.map.tile.forge.core.support.local.LocalZipMvtTilesStorageSupport;
...
/**
 * S3ZIP瓦片存储支持类 提供从ZIP压缩包中读取MvtTiles瓦片数据的功能
 *
 * @author 张俊
 * @since 2025/11/17
 */
public class S3ZipMvtTilesSupport extends LocalZipMvtTilesStorageSupport {
    public static GiLogger log = GirLoggerFactory.getLogger();

    public S3ZipMvtTilesSupport(GirLayerConfigContextHelper contextHelper) {
        super(contextHelper);
    }
