...
/**
 * @author ：张俊 &#064;date ：Created in 2025/11/13 17:58 &#064;description：S3存储支持类，用于处理未压缩的紧凑型V2瓦片数据
 */
public class S3UnzippedCompactV2TileStorageSupport extends S3UnzippedCompactV1TileStorageSupport {
    ...
    public TileRequest getTileData(
        ...
        // 构建远程文件路径
        ArcGISCompactCacheV2 remoteCache =
                new ArcGISCompactCacheV2(layerConfigContext.getTilePathPrefix());
        ...
        // 使用本地缓存访问器读取瓦片数据
        ArcGISCompactCacheV2 localCache =
                new ArcGISCompactCacheV2(tempDirAbsolutePath + File.separator + "_alllayers");
