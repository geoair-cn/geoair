            ...
            if (b) {
                ...
                iCompressionHandler.scanAllEntries(
                        ...
                        (centralDirectoryEntry, allCount, currentCount) -> {
                            ...
                            if (GutilObject.isNotEmpty(rootPathInfo.getRootFilePath())
                                    && name.equals(rootPathInfo.getRootFilePath())) {
                                log.info("根文件的位置为===={}", name);
                                centralDirectoryEntry.setName(
                                        rootPathInfo.getRootFileStandardName());
                            } else {
