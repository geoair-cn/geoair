...
/**
 * 图层ZIP配置数据访问接口
 * 定义对LayerZipConfig的CRUD操作（实际项目中可基于JPA/MyBatis实现）
 */
public interface GirLayerConfigContextHelper {
     ...
     * @return 包含LayerZipConfig的Optional（不存在则为empty）
     */
    Optional<GirLayerConfigContext> getGirLayerConfigContext(GirMapTileType mapTileType, String layerName, String dataId, String fileName);
