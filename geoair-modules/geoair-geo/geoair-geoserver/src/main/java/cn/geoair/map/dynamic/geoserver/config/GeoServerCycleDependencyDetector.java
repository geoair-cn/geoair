...
public class GeoServerCycleDependencyDetector implements ApplicationContextInitializer<ConfigurableApplicationContext> {

	// 标记是否存在GeoServer循环依赖的核心Bean
	private static final String[] CYCLE_BEAN_NAMES = { "geoServer", "resourcePoolInitializer", "wms",
			"loggingInitializer" };
