...
public class GeoServerSecurityBeanConfig {
	...
	// GeoServerPlainTextPasswordEncoder encoder = new
	// GeoServerPlainTextPasswordEncoder();
	...
	// ===================== 规则 DAO =====================
	@Bean
	public DataAccessRuleDAO accessRulesDao(GeoServerDataDirectory dataDirectory, Catalog rawCatalog)
			throws IOException {
		return new GssDataRuleDAO(dataDirectory, rawCatalog);
	}

	@Bean
	public ServiceAccessRuleDAO serviceRulesDao(GeoServerDataDirectory dataDirectory, Catalog rawCatalog)
			throws IOException {
