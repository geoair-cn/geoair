...
public class WorkspaceConvertUtil {
	...
	public WorkspaceInfo convertToWorkspaceInfo(GsWorkspace gsWorkspace) {
		try {
			...
			throw new ServicePublishException("GsWorkspace 转换为 WorkspaceInfo 失败：" + e.getMessage(), e);
		}
	}
	 ...
	 */
	public WorkspaceInfo updateWorkspaceInfo(WorkspaceInfo existingWorkspace, GsWorkspace gsWorkspace) {
