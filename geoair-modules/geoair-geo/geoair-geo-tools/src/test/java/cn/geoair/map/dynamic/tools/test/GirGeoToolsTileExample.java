...
public class GirGeoToolsTileExample {
    ...
    public static void main(String[] args) {
        ...
        RangeApo range = tileOpt.tileRangeByBox(10, new Envelope(116.35, 116.55, 39.85, 40.05), 4326);
        Set<TileZxyApo> zxyList = tileOpt.zxyListByBox(new Envelope(116.35, 116.55, 39.85, 40.05), 4326, 10);

        System.out.println("xyzToTileBox = " + tileBox);
        System.out.println("xyzToWkt = " + wkt);
        System.out.println("tileRangeByBox = minX:" + range.getMinX() + ", maxX:" + range.getMaxX());
