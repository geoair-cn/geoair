...
public class GirGeoToolsMeasureExample {
    ...
    public static void main(String[] args) {
        ...
        double areaKm2 = measureOpt.calculateArea(polygon, 4326, GirGeoMeasureOpt.UNIT_SQUARE_KILOMETER);
        double areaByUtm = measureOpt.calculateAreaByUTM(polygon, 4326, GirGeoMeasureOpt.UNIT_SQUARE_METER);
        double lengthKm = measureOpt.calculateLength(line, 4326, GirGeoMeasureOpt.UNIT_KILOMETER);
        double lengthByUtm = measureOpt.calculateLengthByUTM(line, 4326, GirGeoMeasureOpt.UNIT_METER);
        double pointDistance = measureOpt.calculatePointToPointDistance(point1, point2, 4326, GirGeoMeasureOpt.UNIT_METER);
        double pointToLine = measureOpt.calculatePointToLineMinDistance(point1, line, 4326, GirGeoMeasureOpt.UNIT_METER);
        double converted = measureOpt.convertUnit(1000, GirGeoMeasureOpt.UNIT_METER, GirGeoMeasureOpt.UNIT_KILOMETER, 3857);
