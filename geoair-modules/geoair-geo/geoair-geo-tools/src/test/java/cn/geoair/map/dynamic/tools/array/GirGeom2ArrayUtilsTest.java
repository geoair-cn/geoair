...
public class GirGeom2ArrayUtilsTest {
    ...
    public void shouldReuseConfiguredInstanceAndBuildPolygonWithHoles() {
        ...
        double[][] shell = {{116.40D, 39.90D}, {116.45D, 39.90D}, {116.45D, 39.95D}, {116.40D, 39.95D}};
        double[][] hole = {{116.41D, 39.91D}, {116.42D, 39.91D}, {116.42D, 39.92D}, {116.41D, 39.92D}};
        Polygon polygon = arrayUtils.doubleArrayToPolygon(
                shell,
        ...
        Assert.assertEquals(2, arrayUtils.polygonToDoubleArrays(
                polygon, GirGeom2ArrayOpt.CoordOrder.X_FIRST).length);
    }

    @Test(expected = IllegalArgumentException.class)
    public void shouldRejectLineStringWithOnlyOneCoordinate() {
        GirGeom2ArrayUtils.getInstance(new ToolsConfig()).doubleArrayToLineString(
                new double[][]{{116.40D, 39.90D}});
    }
