...
public class GirGeoMeasureUtilsTest {
    ...
    public void shouldPrintDistanceDifferencesForSameCoordinates() {
        ...
        double webMercatorMeters = measureOpt.calculatePointToPointDistance(
                point1, point2, 4326, MeasureUnitEnum.METER, MeasureMethodEnum.WEB_MERCATOR);
        double utmMeters = measureOpt.calculatePointToPointDistance(
                point1, point2, 4326, MeasureUnitEnum.METER, MeasureMethodEnum.UTM);
        double geodeticMeters = measureOpt.calculatePointToPointDistance(
                point1, point2, 4326, MeasureUnitEnum.METER, MeasureMethodEnum.GEODETIC);

        double geodeticLengthMeters = measureOpt.calculateLength(
                line, 4326, MeasureUnitEnum.METER, MeasureMethodEnum.GEODETIC);
        double geodeticKilometers = measureOpt.calculatePointToPointDistance(
                point1, point2, 4326, MeasureUnitEnum.KILOMETER, MeasureMethodEnum.GEODETIC);
        double geodeticMiles = measureOpt.calculatePointToPointDistance(
                point1, point2, 4326, MeasureUnitEnum.MILE, MeasureMethodEnum.GEODETIC);
        double geodeticDegrees = measureOpt.calculatePointToPointDistance(
        ...
        Assert.assertTrue("Web Mercator 在北纬 40 度应明显大于大地线距离", webMercatorMeters > geodeticMeters * 1.2D);
