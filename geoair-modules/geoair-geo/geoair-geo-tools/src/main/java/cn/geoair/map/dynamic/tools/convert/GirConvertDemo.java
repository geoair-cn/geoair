...
/**
 * @author ：张逢吉
 * @date ：Created in 2025/12/5 18:04 @description： TODO
 */
public class GirConvertDemo {

    public static void main(String[] args) {
        // 获取单例实例
        GirFormatUtils geoUtils = GirFormatUtils.getInstance(new GirAdvToolsGlobalConfig());

        // GeoJSON转JTS Point（便捷方法）
        Point point =
                (Point)
                        geoUtils.geojsonToJtsGeometry(
