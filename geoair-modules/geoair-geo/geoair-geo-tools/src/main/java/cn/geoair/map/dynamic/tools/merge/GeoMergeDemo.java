...
public class GeoMergeDemo {
    ...
    public static void main(String[] args) {
        ...
        LineString line1 =
                gf.createLineString(
                        new Coordinate[] {
                            new Coordinate(116.40, 39.90), new Coordinate(116.41, 39.90)
                        });
        LineString line2 =
                gf.createLineString(
                        new Coordinate[] {
                            new Coordinate(116.41, 39.90), new Coordinate(116.42, 39.90)
                        });
        MultiLineString multiLine =
                mergeUtils.mergeToMultiLineString(new LineString[] {line1, line2});
