...
/**
 * @author ：张逢吉
 * @date ：Created in 2025/12/29 09:55 该参数有歧义，所以把参数进行了替换修改
 */
@Data
...
public class PgConnectInfo implements Serializable {
    ...
    public static PgConnectInfo fromPgConnectInfoWithTable(
            PgConnectInfoWithTable pgConnectInfoWithTable) {
