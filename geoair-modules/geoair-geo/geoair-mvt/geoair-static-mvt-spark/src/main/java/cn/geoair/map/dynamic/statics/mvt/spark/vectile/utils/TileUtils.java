...
public class TileUtils {
    ...
    public static Tuple4<Integer, Integer, Integer, Integer> rangeToIndex(
        ...
        if (outGridSrid == 3857) {
            rangeApo = GirGeoTools.me().getTileGrid3857Opt().tileRangeByGeom(((int) level), geometry);
        } else {
            rangeApo = GirGeoTools.me().getTileGrid4326Opt().tileRangeByGeom(((int) level), geometry);
        }
        return new Tuple4<>(
