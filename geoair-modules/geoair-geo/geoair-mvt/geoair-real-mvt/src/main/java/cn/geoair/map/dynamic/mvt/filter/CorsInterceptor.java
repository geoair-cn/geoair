...
public class CorsInterceptor implements HandlerInterceptor {
	...
	private static final String DEFAULT_ALLOWED_HEADERS = "authorization, X-Requested-With, Content-Type";
	...
	private void configureCorsHeaders(HttpServletRequest request, HttpServletResponse response) {
		...
		String allowedHeaders = StrUtil.isNotBlank(requestHeaders) ? DEFAULT_ALLOWED_HEADERS + "," + requestHeaders
