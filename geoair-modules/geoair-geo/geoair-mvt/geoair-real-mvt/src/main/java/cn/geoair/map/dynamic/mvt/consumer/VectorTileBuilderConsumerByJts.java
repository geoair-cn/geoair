...
public class VectorTileBuilderConsumerByJts extends VectorTileBuilderConsumer {
	...
	private VectorTileBuilderConsumerByJts(Envelope envelope, String layerName, int outGridSrid,
	 ...
	 */
	public static VectorTileBuilderConsumerByJts create(Envelope envelope, String layerName, int outGridSrid,
			TileGlobalConfig tileGlobalConfig) {
