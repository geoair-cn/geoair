package com.tc.tools.geowebcache.fuser.fuser;
 ...
 */
@Slf4j
public class GtcFuserExecFactory {
    ...
    public static CacheTileFuserExec createCachedFuser(String layerName, Integer z, Integer x, Integer y,
        ...
        // 获取瓦片获取器
        LayerTileGetter layerTileGetter = GtcFuser.getLayerTileGetter(layerName);
        ...
        // 创建GtcTileFuser
        FuserExec tileFuser = new GtcFuserExec(layerTileGetter, outputFormat, bounds, width, height);
    ...
    public static FuserExec createFuser(String layerName, BoundingBox bounds,
        ...
        return new GtcFuserExec(layerTileGetter, outputFormat, bounds, width, height);
    }
