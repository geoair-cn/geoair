 ...
 * MBTiles 瓦片信息对象
 * <p>
 * 对应 tiles 表结构：zoom_level, tile_column, tile_row, tile_data
 * </p>
 *
 * @author 张俊
...
public class MbtilesInfo {
    ...
    /**
     * 行号 (Tile Row / Y)
     * 注意：MBTiles 标准中 y 轴方向为 TMS 格式（从南到北）
     */
    ...
    public String toString() {
        return String.format("MbtilesInfo{z=%d, x=%d, y=%d, size=%d}",
     ...
     * <p>
     * 支持 PNG、JPG、WebP 等图片格式，不支持 PBF 矢量瓦片
     * </p>
     *
