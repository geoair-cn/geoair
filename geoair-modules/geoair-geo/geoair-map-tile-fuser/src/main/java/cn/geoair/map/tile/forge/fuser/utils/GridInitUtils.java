...
public class GridInitUtils {
    ...
    static GridSubset WORLD_GRID_3857 =
            GridSubsetFactory.createGridSubSet(
                    defaultGridsets.worldMercatorWGS84Quad(), BoundingBox.WORLD3857, 0, 21);

    /** 天地图网格的最大区别就是 0级是 1.40625 */
    static GridSet TIANDITU =
    ...
    static GridSubset WORLD_GRID_TDT =
            GridSubsetFactory.createGridSubSet(TIANDITU, BoundingBox.WORLD4326, 0, 21);
