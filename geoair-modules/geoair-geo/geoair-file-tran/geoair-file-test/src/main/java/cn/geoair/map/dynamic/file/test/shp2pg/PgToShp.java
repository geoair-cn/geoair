...
import cn.geoair.map.dynamic.file.postgis.PostgisGeoFileReader;
...
public class PgToShp {
    ...
    public static void main(String[] args) throws IOException {
        ...
        LinkInfo writeLink =
                new ShpLinkInfo()
                        .setShpFilePath("H:\\项目文件\\黑龙江\\BD党政机关\\BD党政机关.shp")
                        .setCharset("UTF-8");
        GeoFileWriter geoFileWriter = new ShpGeoFileWriter();
        ...
        PostgisLinkInfo postgisLinkInfo =
                new PostgisReadLinkInfo()
                        .setQuerySqlByOutPut("select * from shp_pg_test_2036689320305029120 ")
