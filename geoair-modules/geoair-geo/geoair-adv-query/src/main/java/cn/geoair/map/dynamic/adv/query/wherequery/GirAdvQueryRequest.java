...
public class GirAdvQueryRequest {
    ...
    public <T> GirAdvQueryRequest(QueryRequestBuilder<T> builder) {
        if (GutilObject.isEmpty(builder.getTableOrSqlView())
                && GutilObject.isNotEmpty(builder.getEntityClass())) {
            String tableNameByAnnotation =
                    GirAdvSqlUtils.getTableNameByAnnotation(builder.getEntityClass());
        ...
        this.fieldNames =
                GutilObject.isNotEmpty(builder.getFieldNames())
                        ...
                        : ListUtil.empty();
        this.exprColumnNames =
                GutilObject.isNotEmpty(builder.getExprFieldNames())
                        ? new ArrayList<>(builder.getExprFieldNames())
                        : ListUtil.empty();
        ...
        this.groupByFields =
                builder.getGroupByFields() != null
                        ? new ArrayList<>(builder.getGroupByFields())
                        : new ArrayList<>();
