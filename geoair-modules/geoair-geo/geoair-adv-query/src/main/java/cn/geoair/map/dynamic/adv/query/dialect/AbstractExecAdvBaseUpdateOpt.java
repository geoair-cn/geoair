...
public abstract class AbstractExecAdvBaseUpdateOpt implements IAdvBaseUpdateOpt {
    ...
    public Integer bUpdateByPK(
        ...
        try {
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(
                            this.getClass(), "bUpdateByPrimaryKey", execSql, params, cost, result);
            return result;
        } catch (SQLException e) {
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(this.getClass(), "bUpdateByPrimaryKey", execSql, params, e);
    ...
    public <T> Integer bUpdateByPK(
        ...
        return bUpdateByPK(
                tableName, idKey, entity, isToUnderlineCase, ignoreNullValue, ListUtil.empty());
    }
    ...
    public <T> Integer bUpdateByPK(
        ...
        Map<String, Object> rowData =
                GirAdvSqlUtils.getRowData(
                        entity, isToUnderlineCase, ignoreNullValue, ignoreFieldNames);
    ...
    public Integer bUpdateByMap(
        ...
        try {
            ...
            long cost = stopWatch.getLastTaskTimeMillis();
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(this.getClass(), "bUpdateByMap", execSql, params, cost, result);
            return result;
        } catch (SQLException e) {
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(this.getClass(), "bUpdateByMap", execSql, params, e);
    ...
    public Integer bUpsert(
        ...
        String placeholders =
                rowData.keySet().stream().map(key -> "?").collect(Collectors.joining(","));
        ...
        try {
            ...
            long cost = stopWatch.getLastTaskTimeMillis();
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(this.getClass(), "bUpsert", execSql, params, cost, result);
            return result;
        } catch (SQLException e) {
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(this.getClass(), "bUpsert", execSql, params, e);
    ...
    public <T> Integer bUpdateByWhere(
        ...
        Map<String, Object> rowData =
                GirAdvSqlUtils.getRowData(entity, toUnderlineCase, false, ignoreFieldNames);
    ...
    public <T> Integer bUpdateByWhere(
        ...
        try {
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(
                            this.getClass(), "bUpdateByWhere", execSql, params, cost, result);
            return result;
        } catch (SQLException e) {
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(this.getClass(), "bUpdateByWhere", execSql, params, e);
            throw new RuntimeException("条件更新失败，表名：" + tableName, e);
        } finally {
            closeConnection(connection);
        }
