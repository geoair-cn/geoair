...
public abstract class AbstractAdvBaseOpt implements IAdvBaseOpt {
	...
	public Integer bInsertBatchWithBatchSize(String tableName, Set<String> headers, List<Map<String, Object>> rowsData,
			int batchSize) {
		return getAdvBaseAccessPxyOpt().bInsertBatchWithBatchSize(tableName, headers, rowsData, batchSize);
	}
	...
	public Integer bLogicDeleteBatch(String tableName, String idKey, Set<Object> ids, String deleteKey,
			Object deleteValue) {
		return getAdvBaseDeletePxyOpt().bLogicDeleteBatch(tableName, idKey, ids, deleteKey, deleteValue);
	}
	...
	public Integer bUpdateBatchWithBatchSize(String tableName, String idKey, List<Map<String, Object>> rowsData,
			int batchSize) {
		return getAdvBaseUpdatePxyOpt().bUpdateBatchWithBatchSize(tableName, idKey, rowsData, batchSize);
	}
	...
	public Integer bUpdateWithOptimisticLock(String tableName, String idKey, Object id, Map<String, Object> rowData,
		...
		return getAdvBaseUpdatePxyOpt().bUpdateWithOptimisticLock(tableName, idKey, id, rowData, versionKey, version);
	}
