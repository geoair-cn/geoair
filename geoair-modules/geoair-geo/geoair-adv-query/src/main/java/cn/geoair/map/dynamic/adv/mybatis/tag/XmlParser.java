 ...
 * <p>
 * 使用 dom4j 解析 XML，递归遍历元素树，将每个 XML 元素分派给对应的 {@link TagHandler} 处理。
 * 纯文本内容转换为 {@link TextSqlNode}。
 *
 * <p>支持的标签（不区分大小写）：
 * <ul>
...
public class XmlParser {
    ...
    private static final Map<String, TagHandler> NODE_HANDLERS = new HashMap<String, TagHandler>() {{
     ...
     * <p>
     * 纯文本节点转为 {@link TextSqlNode}，XML 元素分派给对应的 {@link TagHandler}。
     *
