...
public class PgAdvBaseAccessOpt extends AbstractExecAdvBaseAccessOpt {
	...
	protected String buildInsertReturnIdSql(String tableName, String fields, String placeholders) {
		// PG：RETURNING 主键语法
		return StrUtil.format("INSERT INTO {} ({}) VALUES ({}) RETURNING {}", tableName, fields, placeholders,
	...
	protected String buildInsertIgnoreSql(String tableName, String fields, String placeholders) {
		...
		return StrUtil.format("INSERT INTO {} ({}) VALUES ({}){}NOTHING", tableName, fields, placeholders,
				PG_CONFLICT_CLAUSE);
	}
	...
	protected String buildInsertOrUpdateSql(String tableName, String fields, String placeholders,
		...
		String updateClause = updateFields.stream().map(field -> StrUtil.format("{} = EXCLUDED.{}", field, field))
				.collect(Collectors.joining(","));

		return StrUtil.format("INSERT INTO {} ({}) VALUES ({}){}UPDATE SET {}", tableName, fields, placeholders,
				PG_CONFLICT_CLAUSE, updateClause);
	}
