...
public abstract class AbstractExecAdvBaseSelectOpt implements IAdvBaseSelectOpt {
    ...
    public AbstractExecAdvBaseSelectOpt(
        ...
        this.beanMapper = new AdvBeanMapper(registry);
    }
        ...
        try {
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(
                            ...
                            execSql,
                            lastTaskTimeMillis,
                            GutilObject.isEmpty(queryResult) ? 0 : 1);
            return GirAdvOneRow.ofByEntity(queryResult).withRegistry(typeHandlerRegistry);
        } catch (SQLException e) {
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(this.getClass(), "bSelectOne", execSql, e);
        ...
        try {
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(
                            ...
                            cleanSql,
                            lastTaskTimeMillis,
                            GutilObject.isEmpty(queryResult) ? 0 : queryResult.size());
            List<GirAdvOneRow> rows = GirAdvOneRow.ofByEntityList(queryResult);
            rows.forEach(r -> r.setTypeHandlerRegistry(typeHandlerRegistry));
            return rows;
        } catch (SQLException e) {
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(this.getClass(), "bSelectList", cleanSql, e);
    ...
    public void bSelectListStream(String sql, Consumer<GirAdvOneRow> rowConsumer) {
        ...
        try {
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(this.getClass(), "bSelectList(流式)", cleanSql, e);
    ...
    public List<List<Object>> bSelectListToValueList(String sql) {
        ...
        try {
            ...
            List<List<Object>> query =
                    SqlExecutor.query(connection, cleanSql, new ValueListHandler());
            stopWatch.stop();
            long lastTaskTimeMillis = stopWatch.getLastTaskTimeMillis();
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(
                            ...
                            cleanSql,
                            lastTaskTimeMillis,
                            GutilObject.isEmpty(query) ? 0 : query.size());
            return query;
        } catch (SQLException e) {
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(this.getClass(), "bSelectListToValueList", cleanSql, e);
        ...
        try {
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(
                            ...
                            cleanSql,
                            lastTaskTimeMillis,
                            GutilObject.isEmpty(query) ? 0 : 1);
            return query;
        } catch (SQLException e) {
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(this.getClass(), "bSelectNumber", cleanSql, e);
    ...
    public <E> E bSelectObjOne(String sql, Class<E> clazz) {
        ...
        try {
            ...
            Object queryResult =
                    SqlExecutor.query(
                            connection, cleanSql, new AdvBeanHandler<>(clazz, this.beanMapper));
            stopWatch.stop();
            long lastTaskTimeMillis = stopWatch.getLastTaskTimeMillis();
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(this.getClass(), "bSelectObjOne", cleanSql, e);
    ...
    public <E> List<E> bSelectObjList(String sql, Class<E> clazz) {
        ...
        try {
            ...
            List<E> query =
                    SqlExecutor.query(
                            connection, cleanSql, new AdvBeanListHandler<>(clazz, this.beanMapper));
            stopWatch.stop();
            long lastTaskTimeMillis = stopWatch.getLastTaskTimeMillis();
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(this.getClass(), "bSelectObjList", cleanSql, e);
            throw new RuntimeException(
        ...
        try {
            ...
            Integer query =
                    SqlExecutor.query(
                            connection,
                            cleanSql,
                            new StreamBeanRsHandler<>(rowConsumer, clazz, this.beanMapper));
            stopWatch.stop();
            long lastTaskTimeMillis = stopWatch.getLastTaskTimeMillis();
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(
                            ...
                            cleanSql,
                            lastTaskTimeMillis,
                            GutilObject.isEmpty(query) ? 0 : query);
        } catch (SQLException e) {
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(this.getClass(), "bSelectObjList(流式)", cleanSql, e);
            throw new RuntimeException(
    ...
    public void bSelectListStream(
        ...
        SqlMeta sqlMeta =
                GirAdvSqlUtils.parseSqlWithParam(dynamicSql, sqlParam, dialectTableNameProcessor);
        bSelectListStream(
                sqlMeta.getSql(), SqlParamList.of(sqlMeta.getJdbcParamValues()), rowConsumer);
    }
    ...
    public <E> E bSelectObjOne(String dynamicSql, SqlParamMap sqlParam, Class<E> clazz) {
        SqlMeta sqlMeta =
                GirAdvSqlUtils.parseSqlWithParam(dynamicSql, sqlParam, dialectTableNameProcessor);
        return bSelectObjOne(
                sqlMeta.getSql(), SqlParamList.of(sqlMeta.getJdbcParamValues()), clazz);
    }
    ...
    public GirAdvOneRow bSelectOne(String sqlStatement, SqlParamList sqlParamList) {
        ...
        try {
            ...
            Entity queryResult =
                    SqlExecutor.query(
                            connection, execSql, new EntityHandler(), sqlParamList.toArray());
            stopWatch.stop();
            long lastTaskTimeMillis = stopWatch.getLastTaskTimeMillis();
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(this.getClass(), "bSelectOne(带参数)", execSql, sqlParamList, e);
    ...
    public List<GirAdvOneRow> bSelectList(String sqlStatement, SqlParamList sqlParamList) {
        ...
        try {
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(
                            this.getClass(), "bSelectList(带参数)", sqlStatement, sqlParamList, e);
    ...
    public void bSelectListStream(
        ...
        try {
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(
                            this.getClass(), "bSelectList(带参数-流式)", sqlStatement, sqlParamList, e);
    ...
    public List<List<Object>> bSelectListToValueList(
        ...
        try {
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(
                            this.getClass(),
                            "bSelectListToValueList(带参数)",
                            sqlStatement,
                            sqlParamList,
                            lastTaskTimeMillis,
                            query == null ? 0 : query.size());
            return query;
        } catch (SQLException e) {
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(
    ...
    public Number bSelectNumber(String sqlStatement, SqlParamList sqlParamList) {
        ...
        try {
            ...
            Number query =
                    SqlExecutor.query(
                            connection, sqlStatement, new NumberHandler(), sqlParamList.toArray());
            stopWatch.stop();
            long lastTaskTimeMillis = stopWatch.getLastTaskTimeMillis();
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(
                            this.getClass(), "bSelectNumber(带参数)", sqlStatement, sqlParamList, e);
    ...
    public Number bSelectRecordRowCount(String sqlStatement, SqlParamList sqlParamList) {
        ...
        try {
            Number query =
                    SqlExecutor.query(
                            connection, countSql, new NumberHandler(), sqlParamList.toArray());
            stopWatch.stop();
            long lastTaskTimeMillis = stopWatch.getLastTaskTimeMillis();
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteSql(
                            this.getClass(),
                            "bSelectRecordRowCount(带参数)",
                            countSql,
                            sqlParamList,
                            lastTaskTimeMillis,
                            GutilObject.isEmpty(query) ? 0 : 1);
        ...
        try {
            ...
            Object queryResult =
                    SqlExecutor.query(
                            connection,
                            sqlStatement,
                            new AdvBeanHandler<>(clazz, this.beanMapper),
                            sqlParamList.toArray());
            stopWatch.stop();
            long lastTaskTimeMillis = stopWatch.getLastTaskTimeMillis();
            AdvLogSql.of(dataSourceGetter, getConfig())
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(
                            this.getClass(), "bSelectObjOne(带参数)", sqlStatement, sqlParamList, e);
            throw new RuntimeException(
        ...
        try {
            ...
            List<E> query =
                    SqlExecutor.query(
                            connection,
                            sqlStatement,
                            new AdvBeanListHandler<>(clazz, this.beanMapper),
                            sqlParamList.toArray());
            stopWatch.stop();
            long lastTaskTimeMillis = stopWatch.getLastTaskTimeMillis();
            AdvLogSql.of(dataSourceGetter, getConfig())
            ...
            AdvLogSql.of(dataSourceGetter, getConfig())
                    .logExecuteError(
                            this.getClass(), "bSelectObjList(带参数)", sqlStatement, sqlParamList, e);
