...
public abstract class AbstractExecAdvBaseSelectOpt implements IAdvBaseSelectOpt {
    ...
    protected String getSchemaName() {
        return dataSourceGetter != null ? GutilObject.isEmpty(dataSourceGetter.getSchemaName()) ?"":dataSourceGetter.getSchemaName() : "";
    }
    ...
    protected String getDataSourceId() {
        return dataSourceGetter != null ? GutilObject.isEmpty(dataSourceGetter.getDataSourceId()) ? "" : dataSourceGetter.getDataSourceId() : "";
    }
    ...
    protected String getDatabaseName() {
        return dataSourceGetter != null ? GutilObject.isEmpty(dataSourceGetter.getDatabaseName()) ? "" : dataSourceGetter.getDatabaseName() : "";
    }
