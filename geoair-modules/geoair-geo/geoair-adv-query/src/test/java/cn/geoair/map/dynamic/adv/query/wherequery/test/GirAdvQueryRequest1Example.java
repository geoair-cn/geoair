 ...
 */
public class GirAdvQueryRequest1Example {
    ...
    public static void basicStringExample() {
        ...
        System.out.println(
                "  - ALL："
                        + GirAdvSqlComposerMockProvider.getMockPostgresql().buildSelectSql(query));
    }
    ...
    public static void lambdaStyleExample() {
        ...
        System.out.println(
                "  - ALL："
                        + GirAdvSqlComposerMockProvider.getMockPostgresql().buildSelectSql(query1));
        // 方式2：带驼峰转下划线
