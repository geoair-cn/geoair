...
import datasourceEdit from '../components/datasource/edit.vue'
import datasourceAdd from '../components/datasource/add.vue'
import datasourceDetail from '../components/datasource/detail.vue'
import api from '../components/api/api.vue'
import {validateToken} from '@/api/dsApi'
import apiAdd from '../components/api/add.vue'
import apiEdit from '../components/api/edit.vue'
import detail from '../components/api/detail.vue'
