...
public class GridSubset {
    ...
    public long[] closestIndex(BoundingBox tileBounds) throws Exception {
    ...
    public void checkCoverage(long[] index) throws Exception {
        if (covers(index)) {
            return;
        }
    ...
    public long[][] getSubGrid(long[] gridLoc) throws Exception {
