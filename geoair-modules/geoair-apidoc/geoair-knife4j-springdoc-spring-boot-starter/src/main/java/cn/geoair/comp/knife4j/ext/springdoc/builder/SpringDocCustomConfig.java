...
public class SpringDocCustomConfig {
                                        ...
                                        .forEach(
                                                operation -> {
                                                    ...
                                                    HandlerMethod handlerMethod =
                                                            (HandlerMethod) handlerMethodObj;
                                                    GaApi gaApi =
    ...
    public OperationCustomizer gaApiActionCustomizer() {
        return (operation, handlerMethod) -> {
            ...
            GaApiAction gaApiAction =
                    AnnotationUtils.findAnnotation(handlerMethod.getMethod(), GaApiAction.class);
            if (gaApiAction != null) {
                // 设置接口摘要
