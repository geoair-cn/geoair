...
public interface DsDataSourceEvent {
    static List<DsDataSourceEvent> getInstances() {
        ...
        Map<String, DsDataSourceEvent> beans =
                Gir.beans.getBeans(DsDataSourceEvent.class);
     ...
     * @param newPo 待更新数据
     */
    default void updateBeforeDsDataSourceEvent(
            DsDataSourceApo oldPo, DsDataSourceApo newPo) {
    }
     ...
     */
    default void deleteAfterDsDataSourceEvent(
            DsDataSourceApo dsDataSourceApo, boolean success) {
    }
     ...
     */
    void getDsDataSourceRelationEvent(
            DsDataSourceApo po, Map<String, Object> relationObj);
