  ...
  <div style="padding: 20px">
    <div>
      <ul>
        ...
        <li>
          <el-button @click="show=true" icon="el-icon-download" round size="mini" plain>{{ $t('m.export_ds') }}
          </el-button>
        </li>
        <li>
...
export default {
  ...
  methods: {
    ...
    getAllSource() {
      dbApi.getAllDataSources().then(res => {
