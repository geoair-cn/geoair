...
public class VelocityUtils {
    ...
    public static VelocityContext prepareContext(
            GenTable genTable, GirGeneratorConfig globalConfig) {
        ...
        velocityContext.put("mutiIs", globalConfig.getMutiIs());

        velocityContext.put("controllerModuleName", globalConfig.getControllerModuleName());
        ...
        velocityContext.put(
                "classname",
                StringUtils.replace(
                        StringUtils.split(genTable.getTableName(), "_", 2)[1], "_", ""));
