 ...
 */
public class ReadWriteSplitPreparedStatementBack extends ReadWriteSplitStatement implements PreparedStatement {
    ...
    public ReadWriteSplitPreparedStatementBack(ReadWriteSplitConnection connection, String sql) {
        super(connection);
        this.sql = sql;
    ...
    public ReadWriteSplitPreparedStatementBack(ReadWriteSplitConnection connection, String sql, int autoGeneratedKeys) {
        this(connection, sql);
        this.autoGeneratedKeys = autoGeneratedKeys;
    }

    public ReadWriteSplitPreparedStatementBack(ReadWriteSplitConnection connection, String sql, int[] columnIndexes) {
        this(connection, sql);
        this.columnIndexes = columnIndexes;
    }

    public ReadWriteSplitPreparedStatementBack(ReadWriteSplitConnection connection, String sql, String[] columnNames) {
        this(connection, sql);
    ...
    private void applyParameter(PreparedStatement stmt, int index, JdbcParameter param) throws SQLException {
        ...
        switch (sqlType) {
            ...
            case Types.DATE:
                if (calendar != null) {
                    stmt.setDate(index, (Date) value, calendar);
                } else {
            ...
            case Types.TIME:
                if (calendar != null) {
                    stmt.setTime(index, (Time) value, calendar);
                } else {
            ...
            case Types.TIMESTAMP:
                if (calendar != null) {
                    stmt.setTimestamp(index, (Timestamp) value, calendar);
                } else {
