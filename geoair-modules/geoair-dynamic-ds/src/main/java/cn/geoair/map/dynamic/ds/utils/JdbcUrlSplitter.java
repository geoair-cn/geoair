...
/**
 * 创建人: 张逢吉 创建时间: 2025/9/30 09:28 描述: 将JDBC URL拆分为各个组件。 从类似以下格式的 JDBC URI 中提取组件： String
 * url = "jdbc:derby://localhost:1527/netld;collation=TERRITORY_BASED:PRIMARY"; 在各自的公共变量中。
 */
@Deprecated
