...
GeoAir Framework 是一个  **Java 开发框架**,提供从基础依赖管理、核心工具库到业务组件的全套解决方案。框架集成了 GeoTools、PostGIS 等地理空间处理库,支持多数据源动态切换、高级空间查询、坐标转换等 GIS 核心功能,并内置 API 文档自动生成、代码生成器等开发效率工具。
