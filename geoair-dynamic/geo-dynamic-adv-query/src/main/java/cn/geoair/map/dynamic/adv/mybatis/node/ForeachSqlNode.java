...
public class ForeachSqlNode implements SqlNode {
	...
	public ForeachSqlNode(String collection, String open, String close, String separator, String item, String index,
			SqlNode contents) {
	...
	public String getChildText(Context proxy, int currentIndex) {
		String newItem = String.format("%s[%d]", collection, currentIndex); // ognl可以直接获取
																			// aaa[0] 形式的值
