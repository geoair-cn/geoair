...
/**
 * @author ：张逢吉
 * @date ：Created in 2025/10/10 10:52
 * @description： 分页对象的返回结果
 */
public class PageApo<T>   implements Serializable {
    ...
    /**
     * 1. 若pageNumStartZero = true（页码从0开始）：OFFSET = pageNum × pageSize
     * 2. 若pageNumStartZero = false（页码从1开始）：OFFSET = (pageNum - 1) × pageSize
     */
