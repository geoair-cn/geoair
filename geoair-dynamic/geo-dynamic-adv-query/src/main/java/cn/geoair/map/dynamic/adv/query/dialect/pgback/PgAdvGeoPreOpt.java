...
// public List<GirAdvOneRow> eSelectList(String sqlStatement, SqlParamMap sqlParam,
// AdvEnumsGeomOpt advEnumsGeomOpt, String geomFieldName) {
// return eSelectList(sqlStatement, sqlParam, advEnumsGeomOpt,
...
// Map<String, AdvEnumsTypeGeom> re = eGetGeoTypeBySql(sqlStatement, sqlParam,
// ListUtil.of(geomFieldName));
...
// try {
// // 构建查询元数据的SQL
// String fieldQuerySql = StrUtil.format("SELECT * FROM ({}) AS {} LIMIT 0", sqlStatement,
// aliasTableName);
...
// sqlParam) {
// List<FieldBySchemaApo> fieldBySchemaApos = eGetGeomColumnListBySql(sqlStatement,
// sqlParam);
