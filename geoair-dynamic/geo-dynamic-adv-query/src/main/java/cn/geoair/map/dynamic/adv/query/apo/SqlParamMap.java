 ...
 * @description： SqlParam的一个map对象，主要是提供一个比较方便的API进行set值
 */
public class SqlParamMap extends LinkedHashMap<String, Object> implements OptNullGeomAndBasicTypeFromObjectGetter, Serializable {
