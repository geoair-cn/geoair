...
public class AdvSqlParser {
    ...
    private static Pair<String, String> parseTableName(String processedSql) {
        ...
        if (matcher.find()) {
            ...
            // 组合schema和表名
//            String fullTableName = (schemaPart != null ? schemaPart + "." : "") + tablePart;
    ...
    public static void main(String[] args) {
        String[] testSqls = {
                "select * from \"geo_poi_list11\" where id = '1497145264652292111' limit 1",  // 双引号表名
                ...
                "SeLeCt user_id as uid, user_name name FrOm t_user",
