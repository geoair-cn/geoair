...
/**
 * 空间处理相关操作接口
 * 约定：所有的方法都以 e开头 (本来设计用g开头，但是后面发现get方法的g开头存在了太多，导致了干扰)
 */
public interface IAdvGeoOpt {
     ...
     * @return 包含距离的查询结果
     */
    List<GirAdvOneRow> eCalculateDistance(String tableName, String geomFieldName, String geometry, int srid, String distanceAlias);
