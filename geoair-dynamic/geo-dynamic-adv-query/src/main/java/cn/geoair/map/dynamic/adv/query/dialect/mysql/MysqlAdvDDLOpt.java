...
public class MysqlAdvDDLOpt extends AbstractAdvDDLOpt {
    ...
    public String buildAlterColumnSql(String qualifiedTableName, String oldColumnName, FieldBySchemaApo newField) {
        ...
        alterDef.append(StrUtil.format("ALTER TABLE {} MODIFY COLUMN {} {}",
    ...
    public List<String> dGetPrimaryKeys(String tableName) {
        ...
        // MySQL专属：主键查询
        String sql = StrUtil.format("SELECT COLUMN_NAME FROM information_schema.KEY_COLUMN_USAGE " +
    ...
    @Override
    public void setFieldLengthInfo(ResultSetMetaData metaData, int columnIndex, FieldBySchemaApo field) throws SQLException {
