...
// return ObjectUtil.isEmpty(dataSourceGetter.getSchemaName()) ? POSTGRESQL_DEFAULT_SCHEMA
...
// return tbGetTableNameWithSchema(dataSourceGetter, tableName,
// dataSourceGetter.getSchemaName());
// }
//
// @Override
...
// // 避免重复加引号：已带双引号则直接返回
// if (StrUtil.isEmpty(tableName) || (tableName.startsWith(POSTGRESQL_QUOTE_CHAR) &&
// tableName.endsWith(POSTGRESQL_QUOTE_CHAR))) {
// return tableName;
// }
...
// // 逻辑同表名引号处理（复用规则）
// if (StrUtil.isEmpty(schemaName) || (schemaName.startsWith(POSTGRESQL_QUOTE_CHAR) &&
// schemaName.endsWith(POSTGRESQL_QUOTE_CHAR))) {
// return schemaName;
// }
