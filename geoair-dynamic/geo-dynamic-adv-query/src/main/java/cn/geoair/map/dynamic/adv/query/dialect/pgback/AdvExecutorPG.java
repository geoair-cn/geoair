...
// DialectTableNameProcessor dialectTableNameProcessorPxy =
...
// return pgAdvBaseOptPxy.bInsertBatchWithBatchSize(tableName, headers, rowsData,
// batchSize);
// }
//
// @Override
...
// return pgAdvBaseOptPxy.bLogicDeleteBatch(tableName, idKey, ids, deleteKey,
// deleteValue);
// }
//
// @Override
...
// List<Map<String, Object>> rowsData, int batchSize) {
// return pgAdvBaseOptPxy.bUpdateBatchWithBatchSize(tableName, idKey, rowsData,
// batchSize);
// }
//
// @Override
...
// return pgAdvBaseOptPxy.bUpdateWithOptimisticLock(tableName, idKey, id, rowData,
// versionKey, version);
// }
//
// @Override
...
//
// @Override
// public int dExecuteDDL(String sqlStatement, SqlParamMap sqlParam, String tableName,
// String operation) {
...
//
// @Override
// public void dCreateTable(String tableName, List<FieldBySchemaApo> fields, String
// primaryKey) {
...
//
// @Override
// public void dAlterColumn(String tableName, String oldColumnName, FieldBySchemaApo
// newField) {
...
//
// @Override
// public void dAddPrimaryKey(String tableName, List<String> columnNames, String
// constraintName) {
...
//
// @Override
// public void dCreateIndex(String tableName, String indexName, List<String> columnNames,
// boolean isUnique) {
...
// return pgAdvGeoOptPxy.eCalculateDistance(tableName, geomFieldName, geometry, srid,
// distanceAlias);
// }
//
// @Override
...
//
// @Override
// public String pBuildPageSql(String noPageSql, int pageSize, int pageNum, boolean
// pageNumStartZero) {
// return pgAdvSimplePageOptPxy.pBuildPageSql(noPageSql, pageSize, pageNum,
// pageNumStartZero);
// }
//
// @Override
// public String pBuildSqlWithOrder(String baseSql, List<OrderApo> orders, String
// tableAlias) {
...
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSql, int pageNum, int pageSize, boolean
// pageNumStartZero, AdvEnumsGeomOpt advEnumsGeomOpt, boolean hasFieldsInfo,
// List<OrderApo> orders) {
// return pgAdvSimplePageOptPxy.pPage(noPageSql, pageNum, pageSize, pageNumStartZero,
// advEnumsGeomOpt, hasFieldsInfo, orders);
// }
//
// @Override
...
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSql, int pageNum, int pageSize, boolean
// pageNumStartZero, boolean hasFieldsInfo) {
// return pgAdvSimplePageOptPxy.pPage(noPageSql, pageNum, pageSize, pageNumStartZero,
// hasFieldsInfo);
// }
//
...
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSql, int pageNum, int pageSize, boolean
// pageNumStartZero, List<OrderApo> orders) {
// return pgAdvSimplePageOptPxy.pPage(noPageSql, pageNum, pageSize, pageNumStartZero,
// orders);
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSql, int pageNum, int pageSize, boolean
// pageNumStartZero, AdvEnumsGeomOpt advEnumsGeomOpt) {
// return pgAdvSimplePageOptPxy.pPage(noPageSql, pageNum, pageSize, pageNumStartZero,
// advEnumsGeomOpt);
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSql, int pageNum, int pageSize, boolean
// pageNumStartZero, AdvEnumsGeomOpt advEnumsGeomOpt, List<OrderApo> orders) {
// return pgAdvSimplePageOptPxy.pPage(noPageSql, pageNum, pageSize, pageNumStartZero,
// advEnumsGeomOpt, orders);
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSql, int pageNum, int pageSize,
...
//
// @Override
// public String tbGetTableNameWithSchema(IDataSourceGetter dataSourceGetter, String
// tableName) {
// // 代理调用：带默认Schema的完整表名拼接
// return dialectTableNameProcessorPxy.tbGetTableNameWithSchema(dataSourceGetter,
// tableName);
// }
//
// @Override
...
//
// @Override
// public GirAdvOneRow eSelectOne(String sqlStatement, SqlParamMap sqlParam,
// AdvEnumsGeomOpt advEnumsGeomOpt) {
// return pgAdvGeoPreOptPxy.eSelectOne(sqlStatement, sqlParam, advEnumsGeomOpt);
// }
//
// @Override
// public GirAdvOneRow eSelectOne(String sqlStatement, SqlParamMap sqlParam,
// AdvEnumsGeomOpt advEnumsGeomOpt, String geomFieldName) {
// return pgAdvGeoPreOptPxy.eSelectOne(sqlStatement, sqlParam, advEnumsGeomOpt,
// geomFieldName);
// }
//
...
//
// @Override
// public List<GirAdvOneRow> eSelectList(String sqlStatement, SqlParamMap sqlParam,
// AdvEnumsGeomOpt advEnumsGeomOpt) {
// return pgAdvGeoPreOptPxy.eSelectList(sqlStatement, sqlParam, advEnumsGeomOpt);
// }
//
// @Override
// public List<GirAdvOneRow> eSelectList(String sqlStatement, SqlParamMap sqlParam,
...
// return pgAdvGeoPreOptPxy.eGetGeoTypeBySql(sqlStatement, sqlParam);
// }
//
// @Override
// public AdvEnumsTypeGeom eGetGeoTypeBySql(String sqlStatement, SqlParamMap sqlParam,
// String geomFieldName) {
// return pgAdvGeoPreOptPxy.eGetGeoTypeBySql(sqlStatement, sqlParam, geomFieldName);
// }
//
// @Override
// public Map<String, AdvEnumsTypeGeom> eGetGeoTypeBySql(String sqlStatement, SqlParamMap
// sqlParam, List<String> geomFieldNames) {
// return pgAdvGeoPreOptPxy.eGetGeoTypeBySql(sqlStatement, sqlParam, geomFieldNames);
// }
//
// @Override
// public boolean eIsGeomBySql(String sqlStatement, SqlParamMap sqlParam) {
// return pgAdvGeoPreOptPxy.eIsGeomBySql(sqlStatement, sqlParam);
// }
//
// @Override
// public String eGetGeomColumnNameBySql(String sqlStatement, SqlParamMap sqlParam) {
// return pgAdvGeoPreOptPxy.eGetGeomColumnNameBySql(sqlStatement, sqlParam);
// }
//
// @Override
// public List<String> eGetGeomColumnNameListBySql(String sqlStatement, SqlParamMap
// sqlParam) {
// return pgAdvGeoPreOptPxy.eGetGeomColumnNameListBySql(sqlStatement, sqlParam);
// }
//
// @Override
// public List<FieldBySchemaApo> eGetGeomColumnListBySql(String sqlStatement, SqlParamMap
// sqlParam) {
// return pgAdvGeoPreOptPxy.eGetGeomColumnListBySql(sqlStatement, sqlParam);
// }
//
// @Override
...
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
// pageNum, int pageSize, boolean pageNumStartZero, AdvEnumsGeomOpt advEnumsGeomOpt,
// boolean hasFieldsInfo, List<OrderApo> orders) {
// return pgAdvSimplePagePreOptPxy.pPage(noPageSqlStatement, sqlParam, pageNum, pageSize,
// pageNumStartZero, advEnumsGeomOpt, hasFieldsInfo, orders);
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
...
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
// pageNum, int pageSize, AdvEnumsGeomOpt advEnumsGeomOpt) {
// return pgAdvSimplePagePreOptPxy.pPage(noPageSqlStatement, sqlParam, pageNum, pageSize,
// advEnumsGeomOpt);
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
// pageNum, int pageSize, List<OrderApo> orders) {
// return pgAdvSimplePagePreOptPxy.pPage(noPageSqlStatement, sqlParam, pageNum, pageSize,
// orders);
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
// pageNum, int pageSize, boolean pageNumStartZero, boolean hasFieldsInfo) {
// return pgAdvSimplePagePreOptPxy.pPage(noPageSqlStatement, sqlParam, pageNum, pageSize,
// pageNumStartZero, hasFieldsInfo);
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
...
// return pgAdvSimplePagePreOptPxy.pPage(noPageSqlStatement, sqlParam, pageNum, pageSize,
// pageNumStartZero, advEnumsGeomOpt, hasFieldsInfo);
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
// pageNum, int pageSize, boolean pageNumStartZero) {
// return pgAdvSimplePagePreOptPxy.pPage(noPageSqlStatement, sqlParam, pageNum, pageSize,
// pageNumStartZero);
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
// pageNum, int pageSize, boolean pageNumStartZero, List<OrderApo> orders) {
// return pgAdvSimplePagePreOptPxy.pPage(noPageSqlStatement, sqlParam, pageNum, pageSize,
// pageNumStartZero, orders);
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
// pageNum, int pageSize, boolean pageNumStartZero, AdvEnumsGeomOpt advEnumsGeomOpt) {
// return pgAdvSimplePagePreOptPxy.pPage(noPageSqlStatement, sqlParam, pageNum, pageSize,
// pageNumStartZero, advEnumsGeomOpt);
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
...
// List<OrderApo> orders) {
// return pgAdvSimplePagePreOptPxy.pPage(noPageSqlStatement, sqlParam, pageNum, pageSize,
// pageNumStartZero, advEnumsGeomOpt, orders);
// }
//
// @Override
// public PageApo<GirAdvOneRow> pPage(String noPageSqlStatement, SqlParamMap sqlParam, int
// pageNum, int pageSize, AdvEnumsGeomOpt advEnumsGeomOpt, boolean hasFieldsInfo) {
// return pgAdvSimplePagePreOptPxy.pPage(noPageSqlStatement, sqlParam, pageNum, pageSize,
// advEnumsGeomOpt, hasFieldsInfo);
// }
//
