...
public interface GirTileConverterOpt {
     ...
     */
    int convertSeparateAxisYToEqualAxisY(int separateAxisY, int zoom, AbstractWgs84TileConverter.RoundingType roundingType);
     ...
     * @return 非等轴Y索引（XYZ规范）
     */
    int convertEqualAxisYToSeparateAxisY(int equalAxisY, int zoom, AbstractWgs84TileConverter.RoundingType roundingType);
