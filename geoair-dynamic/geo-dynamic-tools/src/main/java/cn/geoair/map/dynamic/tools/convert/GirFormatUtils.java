...
public class GirFormatUtils implements GirGeoFormatOpt {
	...
	public LineString wktToJtsLineString(String wktString, boolean ifExceptionValueReturnNull) {
		return castGeometry(wktToJtsGeometry(wktString, ifExceptionValueReturnNull), LineString.class,
	...
	public MultiLineString wktToJtsMultiLineString(String wktString, boolean ifExceptionValueReturnNull) {
		return castGeometry(wktToJtsGeometry(wktString, ifExceptionValueReturnNull), MultiLineString.class,
				ifExceptionValueReturnNull);
	}

	@Override
	public Polygon wktToJtsPolygon(String wktString, boolean ifExceptionValueReturnNull) {
		return castGeometry(wktToJtsGeometry(wktString, ifExceptionValueReturnNull), Polygon.class,
				ifExceptionValueReturnNull);
	}

	@Override
	public MultiPolygon wktToJtsMultiPolygon(String wktString, boolean ifExceptionValueReturnNull) {
		return castGeometry(wktToJtsGeometry(wktString, ifExceptionValueReturnNull), MultiPolygon.class,
				ifExceptionValueReturnNull);
	}

	@Override
	public Point wktToJtsPoint(String wktString, boolean ifExceptionValueReturnNull) {
		return castGeometry(wktToJtsGeometry(wktString, ifExceptionValueReturnNull), Point.class,
				ifExceptionValueReturnNull);
	}

	@Override
	public MultiPoint wktToJtsMultiPoint(String wktString, boolean ifExceptionValueReturnNull) {
		return castGeometry(wktToJtsGeometry(wktString, ifExceptionValueReturnNull), MultiPoint.class,
				ifExceptionValueReturnNull);
	}
	...
	// ==============================String转换功能==============================
	@Override
	public Point jtsPointByString(String pointString, String separator, boolean xFirst,
	...
	public Point jtsPointByStringList(List<?> pointList, boolean xFirst, boolean ifExceptionValueReturnNull) {
		...
		try {
			...
			return xFirst ? jtsPointByXY(x, y, ifExceptionValueReturnNull)
	 ...
	 * 处理几何对象转字符串
	 */
	private String handleGeometryToString(Geometry geometry, GeometryToStringFunction function,
			boolean ifExceptionValueReturnNull) {
		if (ObjectUtil.isNull(geometry)) {
			return ifExceptionValueReturnNull ? null : throwEmptyParamException("geometry");
		}
	 ...
	 * 几何对象类型转换
	 */
	private <T extends Geometry> T castGeometry(Geometry geometry, Class<T> targetClass,
			boolean ifExceptionValueReturnNull) {
		if (ObjectUtil.isNull(geometry)) {
			return ifExceptionValueReturnNull ? null : throwEmptyParamException("geometry");
		}
		try {
			if (targetClass.isInstance(geometry)) {
				...
				throw new RuntimeException(
						"几何类型不匹配，期望：" + targetClass.getSimpleName() + "，实际：" + geometry.getGeometryType());
			}
		}
		catch (Exception e) {
			return handleException(e, ifExceptionValueReturnNull, null);
