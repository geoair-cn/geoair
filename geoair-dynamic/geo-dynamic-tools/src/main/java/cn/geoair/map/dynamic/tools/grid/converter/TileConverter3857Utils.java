...
public class TileConverter3857Utils extends TileConverterCommon  {
    ...
    @Override
    public int convertSeparateAxisYToEqualAxisY(int separateAxisY, int zoom, AbstractWgs84TileConverter.RoundingType roundingType) {
        return separateAxisY;
    }

    @Override
    public int convertEqualAxisYToSeparateAxisY(int equalAxisY, int zoom, AbstractWgs84TileConverter.RoundingType roundingType) {
        return equalAxisY;
    }
