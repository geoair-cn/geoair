...
public class DataSourceService {
	...
	public List<DataSource> getAll() {
		...
		List<DbApiDataSourcePo> collect = dbApiDataSourcePos.stream()
				.sorted(Comparator.comparing(DbApiDataSourcePo::getTimeUpdate).reversed()).collect(Collectors.toList());
