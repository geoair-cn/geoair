...
import cn.geoair.map.dynamic.dbservice.controller.dbapi.group.GroupSearchVo;
...
public class GroupController {
	...
	@Resource
	private DbApiGroupDao dbApiGroupDao;
	...
	@RequestMapping(value = "/listDbApiGroupPage", method = { RequestMethod.POST })
	@ResponseBody
	public GiResult<GiPager<Group>> listDbApiGroupPage(@Validated @RequestBody GroupSearchVo param) {
