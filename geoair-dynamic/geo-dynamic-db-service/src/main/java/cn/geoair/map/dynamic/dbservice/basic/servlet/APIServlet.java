package cn.geoair.map.dynamic.dbservice.basic.servlet;

import cn.geoair.map.dynamic.dbservice.basic.domain.ApiConfig;
import cn.geoair.map.dynamic.dbservice.basic.executor.Executor;
import cn.geoair.map.dynamic.dbservice.basic.executor.SQLExecutor;
import cn.geoair.map.dynamic.dbservice.basic.service.ApiConfigService;
import cn.geoair.map.dynamic.dbservice.basic.service.ApiService;
import cn.geoair.map.dynamic.dbservice.basic.util.Constants;
...
public class APIServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String realApiContext = apiContext + "/apiServer";
    ...
    public ResponseDto process(
        ...
        try {
            ...
            for (int i = 0; i < tasks.size(); i++) {
                ...
                if (type == Constants.API_EXECUTOR_SQL) executor = sqlExecutor;
                else if (type == Constants.API_EXECUTOR_HTTP) executor = sqlExecutor;
                else if (type == Constants.API_EXECUTOR_ES) executor = sqlExecutor;
