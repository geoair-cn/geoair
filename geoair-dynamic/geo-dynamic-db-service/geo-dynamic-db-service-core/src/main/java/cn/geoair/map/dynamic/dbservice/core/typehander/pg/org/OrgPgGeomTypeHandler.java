package cn.geoair.map.dynamic.dbservice.core.typehander.pg.org;
 ...
 */
public class OrgPgGeomTypeHandler extends BaseTypeHandler<String> {

	public static void register() {
		TypeHandlerRegistry.register(org.postgis.PGgeometry.class, Singleton.get(OrgPgGeomTypeHandler.class));
	}
