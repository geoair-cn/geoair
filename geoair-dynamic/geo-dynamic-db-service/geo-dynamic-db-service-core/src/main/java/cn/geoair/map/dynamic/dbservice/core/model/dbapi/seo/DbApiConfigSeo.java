package cn.geoair.map.dynamic.dbservice.core.model.dbapi.seo;
...
/**
 * api配置信息(DbapiConfig)Seo
 *
 * @author zhangjun
 * @date 2025-07-31
 */
@GaModel(text = "api配置信息SearchDto")
public class DbApiConfigSeo extends DbApiConfigPo {

    private static final long serialVersionUID = 1753953255413L;

    public static DbApiConfigSeo emptySeo() {
        return new DbApiConfigSeo();
    }

    public DbApiConfigSeo copy() {
        DbApiConfigSeo copy = new DbApiConfigSeo();
