...
/**
 * api分组信息(DbapiGroup)Seo
 *
 * @author zhangjun
 * @date 2025-07-31
 */
@GaModel(text = "api分组信息SearchDto")
public class DbApiGroupSeo extends DbApiGroupPo {

    private static final long serialVersionUID = 1753953245130L;

    public static DbApiGroupSeo emptySeo() {
        return new DbApiGroupSeo();
    }

    public DbApiGroupSeo copy() {
        DbApiGroupSeo copy = new DbApiGroupSeo();
