package cn.geoair.map.dynamic.dbservice.core.model.dbapi.entity;
...
@Table(name = "dbapi_config")
public class DbApiConfigPo implements GiCrudEntity<String>, GiEntityIdGenerator<String> {
    ...
    public DbApiConfigPo() {}

    public DbApiConfigPo(String id) {
        if (id == null) {
            id = this.generatorId();
        }
        this.id = id;
    ...
    public static DbApiConfigPo empty() {
        return new DbApiConfigPo();
    }

    public DbApiConfigPo copy() {
        DbApiConfigPo copy = new DbApiConfigPo();
