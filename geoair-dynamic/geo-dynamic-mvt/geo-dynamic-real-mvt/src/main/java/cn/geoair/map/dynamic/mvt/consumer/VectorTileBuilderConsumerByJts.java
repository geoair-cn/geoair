...
public class VectorTileBuilderConsumerByJts extends VectorTileBuilderConsumer {
    ...
    private VectorTileBuilderConsumerByJts(Envelope envelope, String layerName, int outGridSrid, TileGlobalConfig tileGlobalConfig) {
     ...
     */
    public static VectorTileBuilderConsumerByJts create(Envelope envelope, String layerName, int outGridSrid, TileGlobalConfig tileGlobalConfig) {
        return new VectorTileBuilderConsumerByJts(envelope, layerName, outGridSrid, tileGlobalConfig);
    }
