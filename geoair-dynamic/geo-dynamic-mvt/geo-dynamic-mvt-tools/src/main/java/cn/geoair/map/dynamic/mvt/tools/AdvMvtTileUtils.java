...
public class AdvMvtTileUtils {
    ...
    public static TileExecParams getTileExecParamsNotHasSql(int zoom, int x, int y, int sourceGrid, int sourceDataSrid) {
        ...
        tileExecParams.setGridSrid(sourceGrid)
        ...
        if (!ObjectUtil.equals(sourceGrid, sourceDataSrid)) {
            ...
            if (dataExtentBox == null) {
                ...
                throw new RuntimeException(StrUtil.format("网格计算异常：z:{}  x :{} y:{} geometry:{}  gridSrid :{} sourceDataSrid:{} ", zoom, x, y, geometry.toText(), sourceGrid, sourceDataSrid));
            }
        ...
        initExtentBuffer(
                gridExtentBox,
                gridExtentBufferEnvelope::set,
                gridExtentBufferBoxGeom::set
        );
        initExtentBuffer(
                dataExtentBox,
                dataExtentBufferEnvelope::set,
                dataExtentBufferBoxGeom::set
        );
        tileExecParams
