...
//        MathTransform sourceToScreen;
    ...
    public static PipelineBuilder newBuilder(
        ...
        context.worldToScreen = RendererUtilities.worldToScreenTransform(mapArea, paintArea);     // 边界框与画布转换的算子
...
//        context.sourceToScreen = ConcatenatedTransform.create(context.sourceToTargetCrs, context.targetToScreen); // 源往屏幕坐标转换
