...
public class SparkTaskSerializableUtil implements Serializable {
     ...
     */
    public static class IdPageFlatMapFunction implements FlatMapFunction<Integer, GirAdvOneRow>, Serializable {
        private static final long serialVersionUID = 1L;
        ...
        public IdPageFlatMapFunction(TileSliceParameter parameter, String queryStatement, String orderFieldName, int countPerTask) {
        ...
        public Iterator<GirAdvOneRow> call(Integer pageNum) throws Exception {
            ...
            // 打印耗时
            log.info("Spark ID分页任务" + pageNum + "耗时：" + (System.currentTimeMillis() - startTime) +
                    "ms，读取条数：" + pageFeatures.size());
     ...
     */
    public static class BboxFlatMapFunction implements FlatMapFunction<String, GirAdvOneRow>, Serializable {
        private static final long serialVersionUID = 1L;
        // 仅保存可序列化的参数
        private final TileSliceParameter parameter;
        private final String queryStatement;
        ...
        public BboxFlatMapFunction(TileSliceParameter parameter, String queryStatement, String geomFieldName, int sourceDataSrid) {
            this.parameter = parameter;
            this.queryStatement = queryStatement;
        ...
        public Iterator<GirAdvOneRow> call(String partitionCondition) throws Exception {
            ...
            // 构建BBox查询SQL
            String bboxQuerySql = DataReadCommonUtils.buildBboxQuerySql(
                    queryStatement,
                    geomFieldName,
                    xmin, ymin, xmax, ymax,
                    sourceDataSrid
     ...
     * 要素转换函数（可序列化）
     */
    public static class TransformFeatureFunction implements Serializable, org.apache.spark.api.java.function.Function<GirAdvOneRow, GirAdvOneRow> {
        private static final long serialVersionUID = 1L;
        private final TileSliceParameter parameter;
    ...
    public static class AggregateAndLimitFeatureFunction implements Function2<List<GirAdvOneRow>, List<GirAdvOneRow>, List<GirAdvOneRow>>, Serializable {
        private static final long serialVersionUID = 1L;
        private final TileSliceParameter parameter;
        ...
        public List<GirAdvOneRow> call(List<GirAdvOneRow> list1, List<GirAdvOneRow> list2) throws Exception {
            List<GirAdvOneRow> mergedList = VectorTileCommonUtils.aggregateTileFeatures(list1, list2);
     ...
     * 瓦片映射函数（可序列化）
     */
    public static class MapToTileFunction implements PairFlatMapFunction<GirAdvOneRow, String, List<GirAdvOneRow>>, Serializable {
        private static final long serialVersionUID = 1L;
        private final TileSliceParameter parameter;
        ...
        public Iterator<Tuple2<String, List<GirAdvOneRow>>> call(GirAdvOneRow feature) throws Exception {
            ...
            Map<String, List<GirAdvOneRow>> tileMap = VectorTileCommonUtils.mapSingleFeatureToTiles(feature,
    ...
    public static class MapToTileFunctionToStatic implements PairFlatMapFunction<GirAdvOneRow, String, List<GirAdvOneRow>>, Serializable {
        private static final long serialVersionUID = 1L;
        private final TileSliceParameter parameter;
        Integer zoom;
     ...
     * PBF生成函数（可序列化）
     */
    public static class GeneratePbfFunction implements Serializable, org.apache.spark.api.java.function.Function<Tuple2<String, List<GirAdvOneRow>>, Tuple2<String, PbfInfo>> {
        private static final long serialVersionUID = 1L;
        private final TileSliceParameter parameter;
        ...
        @Override
        public Tuple2<String, PbfInfo> call(Tuple2<String, List<GirAdvOneRow>> tileFeature) throws Exception {
            PbfInfo pbf = null;
            try {
                pbf = VectorTileCommonUtils.generateSingleTilePbf(tileFeature._1, tileFeature._2, parameter, pbfTargetInfo);
            } catch (Exception e) {
...
//            wms_y = y;
     ...
     * Row构建函数（可序列化）
     */
    public static class BuildRowFunction implements Serializable, org.apache.spark.api.java.function.Function<Tuple2<String, PbfInfo>, Row> {
        private static final long serialVersionUID = 1L;
        private final TileSliceParameter parameter;
        ...
        public Row call(Tuple2<String, PbfInfo> tuple) throws Exception {
            ...
            return RowFactory.create(zoom, x, tms_y, y,gridSrid, bytes, parameter.getLayerName(), parameter.getEdition());
        }
    }


    public static class BuildRowBoundaryFunction implements Serializable, org.apache.spark.api.java.function.Function<Tuple2<String, PbfInfo>, Row> {
        private static final long serialVersionUID = 1L;
        private final TileSliceParameter parameter;
        ...
        public Row call(Tuple2<String, PbfInfo> tuple) throws Exception {
            ...
            int gridSrid = pbfInfo.getGridSrid();
            int tms_y = getTmsY(zoom, y, x, gridSrid);
            return RowFactory.create(zoom, x, tms_y, y,gridSrid, bytes  , parameter.getLayerNameBoundary(), parameter.getEdition());

        }
    }


    public static class BuildRowLabelFunction implements Serializable, org.apache.spark.api.java.function.Function<Tuple2<String, PbfInfo>, Row> {
        private static final long serialVersionUID = 1L;
        private final TileSliceParameter parameter;
        ...
        public Row call(Tuple2<String, PbfInfo> tuple) throws Exception {
            ...
            int gridSrid = pbfInfo.getGridSrid();
            int tms_y = getTmsY(zoom, y, x, gridSrid);
            return RowFactory.create(zoom, x, tms_y, y,gridSrid, bytes, parameter.getLayerNameLabel(), parameter.getEdition());
