...
public class PgConnectInfo implements Serializable {
    ...
    public PgConnectInfo(String url) {
        ...
        infos = java.util.Arrays.stream(infos)
        ...
        // 解析IP和端口（第5个元素：infos[4]，因为索引从0开始：0=pg:, 1=空, 2=user#pass, 3=ip:port, 4=dbName...）
        // 修正索引：split后数组结构（以完整URL为例）：
        // pg://postgres#tcsd1234/116.198.227.117:35432/address/test1/big_mian
        // split("/") → ["pg:", "", "postgres#tcsd1234", "116.198.227.117:35432", "address", "test1", "big_mian"]
        // 过滤空元素后 → ["pg:", "postgres#tcsd1234", "116.198.227.117:35432", "address", "test1", "big_mian"]
    ...
    public Map<String, String> toParams() {
        ...
        String format = String.format("jdbc:postgresql://%s:%s/%s", this.getIp(), this.getPort(), this.getDbName());
