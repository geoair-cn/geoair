...
/**
 * @author ：张逢吉
 * @date ：Created in 2025/12/26 14:34
 * @description： 只负责计算瓦片的相关参数
 */
public class TileUtils {
     ...
     */
    public static Tuple4<Integer, Integer, Integer, Integer> rangeToIndex(long level, Geometry geometry, int outGridSrid) {
        ...
        return new Tuple4<>(rangeApo.getMinX(), rangeApo.getMaxX(), rangeApo.getMinY(), rangeApo.getMaxY());
    }
