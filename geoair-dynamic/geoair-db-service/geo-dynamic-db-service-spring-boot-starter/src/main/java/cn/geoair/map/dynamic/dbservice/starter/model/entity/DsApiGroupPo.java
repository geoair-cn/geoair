...
@Table(name = "dsapi_group")
public class DsApiGroupPo implements GiCrudEntity<String>, GiEntityIdGenerator<String> {
	...
	public static DsApiGroupPo empty() {
		return new DsApiGroupPo();
	}

	public DsApiGroupPo copy() {
		DsApiGroupPo copy = new DsApiGroupPo();
