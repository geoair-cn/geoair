...
public final class GkPair<A, B> extends GkTuple implements GkiValue0<A>, GkiValue1<B> {
	...
	public GkPair(final A value0, final B value1) {
		super(value0, value1);
		this.val0 = value0;
		this.val1 = value1;
	}
	...
	public <X0> GkTriplet<X0, A, B> addAt0(final X0 value0) {
		return new GkTriplet<X0, A, B>(value0, this.val0, this.val1);
	}

	public <X0> GkTriplet<A, X0, B> addAt1(final X0 value0) {
		return new GkTriplet<A, X0, B>(this.val0, value0, this.val1);
	}

	public <X0> GkTriplet<A, B, X0> addAt2(final X0 value0) {
		return new GkTriplet<A, B, X0>(this.val0, this.val1, value0);
	}

	public <X0, X1> GkQuartet<X0, X1, A, B> addAt0(final X0 value0, final X1 value1) {
		return new GkQuartet<X0, X1, A, B>(value0, value1, this.val0, this.val1);
	}

	public <X0, X1> GkQuartet<A, X0, X1, B> addAt1(final X0 value0, final X1 value1) {
		return new GkQuartet<A, X0, X1, B>(this.val0, value0, value1, this.val1);
	}

	public <X0, X1> GkQuartet<A, B, X0, X1> addAt2(final X0 value0, final X1 value1) {
		return new GkQuartet<A, B, X0, X1>(this.val0, this.val1, value0, value1);
	}

	public <X0, X1, X2> GkQuintet<X0, X1, X2, A, B> addAt0(final X0 value0, final X1 value1, final X2 value2) {
		return new GkQuintet<X0, X1, X2, A, B>(value0, value1, value2, this.val0, this.val1);
	}

	public <X0, X1, X2> GkQuintet<A, X0, X1, X2, B> addAt1(final X0 value0, final X1 value1, final X2 value2) {
		return new GkQuintet<A, X0, X1, X2, B>(this.val0, value0, value1, value2, this.val1);
	}

	public <X0, X1, X2> GkQuintet<A, B, X0, X1, X2> addAt2(final X0 value0, final X1 value1, final X2 value2) {
		return new GkQuintet<A, B, X0, X1, X2>(this.val0, this.val1, value0, value1, value2);
	}

	public <X0, X1, X2, X3> GkSextet<X0, X1, X2, X3, A, B> addAt0(final X0 value0, final X1 value1, final X2 value2,
			final X3 value3) {
		return new GkSextet<X0, X1, X2, X3, A, B>(value0, value1, value2, value3, this.val0, this.val1);
	}

	public <X0, X1, X2, X3> GkSextet<A, X0, X1, X2, X3, B> addAt1(final X0 value0, final X1 value1, final X2 value2,
			final X3 value3) {
		return new GkSextet<A, X0, X1, X2, X3, B>(this.val0, value0, value1, value2, value3, this.val1);
	}

	public <X0, X1, X2, X3> GkSextet<A, B, X0, X1, X2, X3> addAt2(final X0 value0, final X1 value1, final X2 value2,
			final X3 value3) {
		return new GkSextet<A, B, X0, X1, X2, X3>(this.val0, this.val1, value0, value1, value2, value3);
	}

	public <X0, X1, X2, X3, X4> GkSeptet<X0, X1, X2, X3, X4, A, B> addAt0(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new GkSeptet<X0, X1, X2, X3, X4, A, B>(value0, value1, value2, value3, value4, this.val0, this.val1);
	}

	public <X0, X1, X2, X3, X4> GkSeptet<A, X0, X1, X2, X3, X4, B> addAt1(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new GkSeptet<A, X0, X1, X2, X3, X4, B>(this.val0, value0, value1, value2, value3, value4, this.val1);
	}

	public <X0, X1, X2, X3, X4> GkSeptet<A, B, X0, X1, X2, X3, X4> addAt2(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new GkSeptet<A, B, X0, X1, X2, X3, X4>(this.val0, this.val1, value0, value1, value2, value3, value4);
	}

	public <X0, X1, X2, X3, X4, X5> GkOctet<X0, X1, X2, X3, X4, X5, A, B> addAt0(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
		return new GkOctet<X0, X1, X2, X3, X4, X5, A, B>(value0, value1, value2, value3, value4, value5, this.val0,
				this.val1);
	}

	public <X0, X1, X2, X3, X4, X5> GkOctet<A, X0, X1, X2, X3, X4, X5, B> addAt1(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
		return new GkOctet<A, X0, X1, X2, X3, X4, X5, B>(this.val0, value0, value1, value2, value3, value4, value5,
				this.val1);
	}

	public <X0, X1, X2, X3, X4, X5> GkOctet<A, B, X0, X1, X2, X3, X4, X5> addAt2(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
		return new GkOctet<A, B, X0, X1, X2, X3, X4, X5>(this.val0, this.val1, value0, value1, value2, value3, value4,
				value5);
	}

	public <X0, X1, X2, X3, X4, X5, X6> GkEnnead<X0, X1, X2, X3, X4, X5, X6, A, B> addAt0(final X0 value0,
			final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5, final X6 value6) {
		return new GkEnnead<X0, X1, X2, X3, X4, X5, X6, A, B>(value0, value1, value2, value3, value4, value5, value6,
				this.val0, this.val1);
	}

	public <X0, X1, X2, X3, X4, X5, X6> GkEnnead<A, X0, X1, X2, X3, X4, X5, X6, B> addAt1(final X0 value0,
			final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5, final X6 value6) {
		return new GkEnnead<A, X0, X1, X2, X3, X4, X5, X6, B>(this.val0, value0, value1, value2, value3, value4, value5,
				value6, this.val1);
	}

	public <X0, X1, X2, X3, X4, X5, X6> GkEnnead<A, B, X0, X1, X2, X3, X4, X5, X6> addAt2(final X0 value0,
			final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5, final X6 value6) {
		return new GkEnnead<A, B, X0, X1, X2, X3, X4, X5, X6>(this.val0, this.val1, value0, value1, value2, value3,
				value4, value5, value6);
	}

	public <X0, X1, X2, X3, X4, X5, X6, X7> GkDecade<X0, X1, X2, X3, X4, X5, X6, X7, A, B> addAt0(final X0 value0,
			final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5, final X6 value6,
			final X7 value7) {
		return new GkDecade<X0, X1, X2, X3, X4, X5, X6, X7, A, B>(value0, value1, value2, value3, value4, value5,
				value6, value7, this.val0, this.val1);
	}

	public <X0, X1, X2, X3, X4, X5, X6, X7> GkDecade<A, X0, X1, X2, X3, X4, X5, X6, X7, B> addAt1(final X0 value0,
			final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5, final X6 value6,
			final X7 value7) {
		return new GkDecade<A, X0, X1, X2, X3, X4, X5, X6, X7, B>(this.val0, value0, value1, value2, value3, value4,
				value5, value6, value7, this.val1);
	}

	public <X0, X1, X2, X3, X4, X5, X6, X7> GkDecade<A, B, X0, X1, X2, X3, X4, X5, X6, X7> addAt2(final X0 value0,
			final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5, final X6 value6,
			final X7 value7) {
		return new GkDecade<A, B, X0, X1, X2, X3, X4, X5, X6, X7>(this.val0, this.val1, value0, value1, value2, value3,
	...
	public <X0, X1, X2, X3, X4, X5> GkOctet<X0, X1, X2, X3, X4, X5, A, B> addAt0(
			final GkSextet<X0, X1, X2, X3, X4, X5> tuple) {
		return addAt0(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(),
				tuple.getValue5());
	}

	public <X0, X1, X2, X3, X4, X5> GkOctet<A, X0, X1, X2, X3, X4, X5, B> addAt1(
			final GkSextet<X0, X1, X2, X3, X4, X5> tuple) {
		return addAt1(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(),
				tuple.getValue5());
	}

	public <X0, X1, X2, X3, X4, X5> GkOctet<A, B, X0, X1, X2, X3, X4, X5> addAt2(
			final GkSextet<X0, X1, X2, X3, X4, X5> tuple) {
		return addAt2(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(),
				tuple.getValue5());
	}

	public <X0, X1, X2, X3, X4, X5, X6> GkEnnead<X0, X1, X2, X3, X4, X5, X6, A, B> addAt0(
			final GkSeptet<X0, X1, X2, X3, X4, X5, X6> tuple) {
		return addAt0(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(),
				tuple.getValue5(), tuple.getValue6());
	}

	public <X0, X1, X2, X3, X4, X5, X6> GkEnnead<A, X0, X1, X2, X3, X4, X5, X6, B> addAt1(
			final GkSeptet<X0, X1, X2, X3, X4, X5, X6> tuple) {
		return addAt1(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(),
				tuple.getValue5(), tuple.getValue6());
	}

	public <X0, X1, X2, X3, X4, X5, X6> GkEnnead<A, B, X0, X1, X2, X3, X4, X5, X6> addAt2(
			final GkSeptet<X0, X1, X2, X3, X4, X5, X6> tuple) {
		return addAt2(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(),
				tuple.getValue5(), tuple.getValue6());
	}

	public <X0, X1, X2, X3, X4, X5, X6, X7> GkDecade<X0, X1, X2, X3, X4, X5, X6, X7, A, B> addAt0(
			final GkOctet<X0, X1, X2, X3, X4, X5, X6, X7> tuple) {
		return addAt0(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(),
				tuple.getValue5(), tuple.getValue6(), tuple.getValue7());
	}

	public <X0, X1, X2, X3, X4, X5, X6, X7> GkDecade<A, X0, X1, X2, X3, X4, X5, X6, X7, B> addAt1(
			final GkOctet<X0, X1, X2, X3, X4, X5, X6, X7> tuple) {
		return addAt1(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(),
				tuple.getValue5(), tuple.getValue6(), tuple.getValue7());
	}

	public <X0, X1, X2, X3, X4, X5, X6, X7> GkDecade<A, B, X0, X1, X2, X3, X4, X5, X6, X7> addAt2(
			final GkOctet<X0, X1, X2, X3, X4, X5, X6, X7> tuple) {
		return addAt2(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(),
				tuple.getValue5(), tuple.getValue6(), tuple.getValue7());
	}
	...
	public <X0, X1, X2, X3> GkSextet<A, B, X0, X1, X2, X3> add(final X0 value0, final X1 value1, final X2 value2,
			final X3 value3) {
	...
	public <X0, X1, X2, X3, X4> GkSeptet<A, B, X0, X1, X2, X3, X4> add(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
	...
	public <X0, X1, X2, X3, X4, X5> GkOctet<A, B, X0, X1, X2, X3, X4, X5> add(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
		return addAt2(value0, value1, value2, value3, value4, value5);
	}

	public <X0, X1, X2, X3, X4, X5> GkOctet<A, B, X0, X1, X2, X3, X4, X5> add(
			final GkSextet<X0, X1, X2, X3, X4, X5> tuple) {
		return addAt2(tuple);
	}

	public <X0, X1, X2, X3, X4, X5, X6> GkEnnead<A, B, X0, X1, X2, X3, X4, X5, X6> add(final X0 value0, final X1 value1,
	...
	public <X0, X1, X2, X3, X4, X5, X6> GkEnnead<A, B, X0, X1, X2, X3, X4, X5, X6> add(
			final GkSeptet<X0, X1, X2, X3, X4, X5, X6> tuple) {
		return addAt2(tuple);
	}

	public <X0, X1, X2, X3, X4, X5, X6, X7> GkDecade<A, B, X0, X1, X2, X3, X4, X5, X6, X7> add(final X0 value0,
			final X1 value1, final X2 value2, final X3 value3, final X4 value4, final X5 value5, final X6 value6,
			final X7 value7) {
		return addAt2(value0, value1, value2, value3, value4, value5, value6, value7);
	}

	public <X0, X1, X2, X3, X4, X5, X6, X7> GkDecade<A, B, X0, X1, X2, X3, X4, X5, X6, X7> add(
			final GkOctet<X0, X1, X2, X3, X4, X5, X6, X7> tuple) {
		return addAt2(tuple);
	}

	public <X> GkPair<X, B> setAt0(final X value) {
		return new GkPair<X, B>(value, this.val1);
	}

	public <X> GkPair<A, X> setAt1(final X value) {
		return new GkPair<A, X>(this.val0, value);
	}

	public GkUnit<B> removeFrom0() {
		return new GkUnit<B>(this.val1);
	}

	public GkUnit<A> removeFrom1() {
		return new GkUnit<A>(this.val0);
	}
