...
public final class GkUnit<A> extends GkTuple implements GkiValue0<A> {
    ...
    public static <X> GkUnit<X> fromArray(final X[] array) {
        ...
        if (array.length != 1) {
            throw new IllegalArgumentException(
                    "Array must have exactly 1 element in order to create a Unit. Size is "
                            + array.length);
        }
    ...
    private static <X> GkUnit<X> fromIterable(
        ...
        if (tooFewElements && exactSize) {
            throw new IllegalArgumentException(
                    "Not enough elements for creating a Unit (1 needed)");
        }
    ...
    public <X0, X1, X2, X3> GkQuintet<A, X0, X1, X2, X3> addAt1(
            final X0 value0, final X1 value1, final X2 value2, final X3 value3) {
        return new GkQuintet<A, X0, X1, X2, X3>(this.val0, value0, value1, value2, value3);
    }

    public <X0, X1, X2, X3, X4> GkSextet<X0, X1, X2, X3, X4, A> addAt0(
    ...
    public <X0, X1, X2, X3, X4> GkSextet<A, X0, X1, X2, X3, X4> addAt1(
            final X0 value0, final X1 value1, final X2 value2, final X3 value3, final X4 value4) {
    ...
    public <X0, X1, X2, X3, X4, X5, X6, X7, X8>
            GkDecade<X0, X1, X2, X3, X4, X5, X6, X7, X8, A> addAt0(
                    final X0 value0,
                    final X1 value1,
                    final X2 value2,
                    final X3 value3,
    ...
    public <X0, X1, X2, X3, X4, X5, X6, X7, X8>
            GkDecade<A, X0, X1, X2, X3, X4, X5, X6, X7, X8> addAt1(
                    final X0 value0,
                    final X1 value1,
                    final X2 value2,
                    final X3 value3,
    ...
    public <X0, X1, X2> GkQuartet<A, X0, X1, X2> add(
            final X0 value0, final X1 value1, final X2 value2) {
    ...
    public <X0, X1, X2, X3> GkQuintet<A, X0, X1, X2, X3> add(
            final X0 value0, final X1 value1, final X2 value2, final X3 value3) {
    ...
    public <X0, X1, X2, X3, X4> GkSextet<A, X0, X1, X2, X3, X4> add(
            final X0 value0, final X1 value1, final X2 value2, final X3 value3, final X4 value4) {
