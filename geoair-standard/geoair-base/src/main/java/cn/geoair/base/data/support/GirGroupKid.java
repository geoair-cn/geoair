...
import cn.geoair.base.data.GiGroup;
...
public class GirGroupKid implements GiGroup {
    ...
    public static GirGroupKid valueOf(
            GiGroupType groupType, String gtcGroupId, String gtcGroupName) {
        return new GirGroupKid(
                GirGroupTypeKid.valueFor(groupType.gtcTypeId()), gtcGroupId, gtcGroupName);
    }
    ...
    @GaModelField() private GirGroupTypeKid gtcGroupType;
