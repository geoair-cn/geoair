...
import cn.geoair.base.data.tuples.valueintf.GkiValueKey;
...
public final class GkKeyValue<A, B> extends GkTuple implements GkiValueKey<A>, GkiValueValue<B> {
    ...
    private static <X> GkKeyValue<X, X> fromIterable(
        ...
        if (tooFewElements && exactSize) {
            throw new IllegalArgumentException(
                    "Not enough elements for creating a KeyValue (2 needed)");
        }
