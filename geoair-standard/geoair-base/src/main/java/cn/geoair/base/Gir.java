...
/**
 * 基础开发库</br> 提供统一的编程接口和常用工具方法，简化开发流程</br>
 *
 * <p>命名规范：</br> Ga* annotation 注解</br> Gi* interface 接口</br> Gir* 实现类</br> Gutil* util 工具类</br>
 * Gfun* function 函数接口</br> Gk* kit 内建工具类</br>
 *
 * @author Ray
 */
public abstract class Gir {
    ...
    public static final GiPropertier property =
            new GiPropertier() {
                ...
                public <T> T getProperty(String key, Class<T> targetType, T defaultValue) {
                    ...
                    return GirPropertyHelper.getPropertier()
    ...
    public static final GiEnvironmenter env =
            new GiEnvironmenter() {
    ...
    public static final GiLogger log =
            new GiLogger() {
    ...
    public static final GiBeanFactory beans =
            new GiBeanFactory() {
                ...
                @Override
                public <T> Map<String, T> getBeans(Class<T> clazz, Type[] genericType)
                        throws GirBeanException {
