...
public abstract class GkTuple implements Iterable<Object>, Serializable, Comparable<GkTuple> {
    ...
    /**
     * //@deprecated Will be removed in 1.4. The "size" parameter is of no use at this level, so use
     * the simpler Tuple(values) constructor instead.
     *
     * <p>//@Deprecated protected Tuple(@SuppressWarnings("unused") final int size, final Object...
     * values) { super(); this.valueArray = values; this.valueList = Arrays.asList(values); }
     */
    protected GkTuple(final Object... values) {
        super();
    ...
    /**
     * Get the value at a specific position in the tuple. This method has to return object, so using
     * it you will lose the type-safety you get with the <tt>getValueX()</tt> methods.
     *
    ...
    public final boolean equals(final Object obj) {
        ...
        final GkTuple other = (GkTuple) obj;
        return this.valueList.equals(other.valueList);
    }

    @SuppressWarnings({"rawtypes", "unchecked"})
    public int compareTo(final GkTuple o) {
