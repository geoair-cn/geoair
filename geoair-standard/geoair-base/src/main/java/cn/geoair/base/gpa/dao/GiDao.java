...
public interface GiDao<M extends GiModelable<PK>, PK extends Serializable> {
     ...
     * @return 指定类型的Dao实例
     */
    public static <DAO extends GiDao<M, PK>, M extends GiModelable<PK>, PK extends Serializable>
            DAO getDao(Class<DAO> daoCls, Class<M> modelCls) {
        return GirBeanHelper.getProvider()
                .getBean(daoCls, new Type[] {modelCls, GiModelable.getIDClass(modelCls)});
    }
