...
public final class GkQuartet<A, B, C, D> extends GkTuple
    ...
    public static <A, B, C, D> GkQuartet<A, B, C, D> with(
            final A value0, final B value1, final C value2, final D value3) {
    ...
    private static <X> GkQuartet<X, X, X, X> fromIterable(
        ...
        if (tooFewElements && exactSize) {
            throw new IllegalArgumentException(
                    "Not enough elements for creating a Quartet (4 needed)");
        }
    ...
    public <X0, X1, X2> GkSeptet<X0, X1, X2, A, B, C, D> addAt0(
    ...
    public <X0, X1, X2> GkSeptet<A, B, C, D, X0, X1, X2> add(
            final X0 value0, final X1 value1, final X2 value2) {
    ...
    public <X0, X1, X2, X3> GkOctet<A, B, C, D, X0, X1, X2, X3> add(
            final X0 value0, final X1 value1, final X2 value2, final X3 value3) {
