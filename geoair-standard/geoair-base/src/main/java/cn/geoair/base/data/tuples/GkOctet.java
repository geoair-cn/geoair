...
public final class GkOctet<A, B, C, D, E, F, G, H> extends GkTuple
    ...
    public static <A, B, C, D, E, F, G, H> GkOctet<A, B, C, D, E, F, G, H> with(
            final A value0,
            final B value1,
            final C value2,
            final D value3,
    ...
    public static <X> GkOctet<X, X, X, X, X, X, X, X> fromArray(final X[] array) {
        ...
        return new GkOctet<X, X, X, X, X, X, X, X>(
     ...
     * @return the tuple
     */
    public static <X> GkOctet<X, X, X, X, X, X, X, X> fromCollection(
     ...
     * @return the tuple
     */
    public static <X> GkOctet<X, X, X, X, X, X, X, X> fromIterable(
            final Iterable<X> iterable, int index) {
        return fromIterable(iterable, index, false);
    }

    private static <X> GkOctet<X, X, X, X, X, X, X, X> fromIterable(
        ...
        if (tooFewElements && exactSize) {
            throw new IllegalArgumentException(
                    "Not enough elements for creating an Octet (8 needed)");
        }
    ...
    public <X0> GkEnnead<X0, A, B, C, D, E, F, G, H> addAt0(final X0 value0) {
        return new GkEnnead<X0, A, B, C, D, E, F, G, H>(
    ...
    public <X0> GkEnnead<A, X0, B, C, D, E, F, G, H> addAt1(final X0 value0) {
        return new GkEnnead<A, X0, B, C, D, E, F, G, H>(
    ...
    public <X0> GkEnnead<A, B, X0, C, D, E, F, G, H> addAt2(final X0 value0) {
        return new GkEnnead<A, B, X0, C, D, E, F, G, H>(
    ...
    public <X0> GkEnnead<A, B, C, X0, D, E, F, G, H> addAt3(final X0 value0) {
        return new GkEnnead<A, B, C, X0, D, E, F, G, H>(
    ...
    public <X0> GkEnnead<A, B, C, D, X0, E, F, G, H> addAt4(final X0 value0) {
        return new GkEnnead<A, B, C, D, X0, E, F, G, H>(
    ...
    public <X0> GkEnnead<A, B, C, D, E, X0, F, G, H> addAt5(final X0 value0) {
        return new GkEnnead<A, B, C, D, E, X0, F, G, H>(
    ...
    public <X0> GkEnnead<A, B, C, D, E, F, X0, G, H> addAt6(final X0 value0) {
        return new GkEnnead<A, B, C, D, E, F, X0, G, H>(
    ...
    public <X0> GkEnnead<A, B, C, D, E, F, G, X0, H> addAt7(final X0 value0) {
        return new GkEnnead<A, B, C, D, E, F, G, X0, H>(
    ...
    public <X0> GkEnnead<A, B, C, D, E, F, G, H, X0> addAt8(final X0 value0) {
        return new GkEnnead<A, B, C, D, E, F, G, H, X0>(
                this.val0, this.val1, this.val2, this.val3, this.val4, this.val5, this.val6,
                this.val7, value0);
    }

    public <X0, X1> GkDecade<X0, X1, A, B, C, D, E, F, G, H> addAt0(
            final X0 value0, final X1 value1) {
        return new GkDecade<X0, X1, A, B, C, D, E, F, G, H>(
                value0, value1, this.val0, this.val1, this.val2, this.val3, this.val4, this.val5,
                this.val6, this.val7);
    }

    public <X0, X1> GkDecade<A, X0, X1, B, C, D, E, F, G, H> addAt1(
            final X0 value0, final X1 value1) {
        return new GkDecade<A, X0, X1, B, C, D, E, F, G, H>(
                this.val0, value0, value1, this.val1, this.val2, this.val3, this.val4, this.val5,
                this.val6, this.val7);
    }

    public <X0, X1> GkDecade<A, B, X0, X1, C, D, E, F, G, H> addAt2(
            final X0 value0, final X1 value1) {
        return new GkDecade<A, B, X0, X1, C, D, E, F, G, H>(
                this.val0, this.val1, value0, value1, this.val2, this.val3, this.val4, this.val5,
                this.val6, this.val7);
    }

    public <X0, X1> GkDecade<A, B, C, X0, X1, D, E, F, G, H> addAt3(
            final X0 value0, final X1 value1) {
        return new GkDecade<A, B, C, X0, X1, D, E, F, G, H>(
                this.val0, this.val1, this.val2, value0, value1, this.val3, this.val4, this.val5,
                this.val6, this.val7);
    }

    public <X0, X1> GkDecade<A, B, C, D, X0, X1, E, F, G, H> addAt4(
            final X0 value0, final X1 value1) {
        return new GkDecade<A, B, C, D, X0, X1, E, F, G, H>(
                this.val0, this.val1, this.val2, this.val3, value0, value1, this.val4, this.val5,
                this.val6, this.val7);
    }

    public <X0, X1> GkDecade<A, B, C, D, E, X0, X1, F, G, H> addAt5(
            final X0 value0, final X1 value1) {
        return new GkDecade<A, B, C, D, E, X0, X1, F, G, H>(
                this.val0, this.val1, this.val2, this.val3, this.val4, value0, value1, this.val5,
                this.val6, this.val7);
    }

    public <X0, X1> GkDecade<A, B, C, D, E, F, X0, X1, G, H> addAt6(
            final X0 value0, final X1 value1) {
        return new GkDecade<A, B, C, D, E, F, X0, X1, G, H>(
                this.val0, this.val1, this.val2, this.val3, this.val4, this.val5, value0, value1,
                this.val6, this.val7);
    }

    public <X0, X1> GkDecade<A, B, C, D, E, F, G, X0, X1, H> addAt7(
            final X0 value0, final X1 value1) {
        return new GkDecade<A, B, C, D, E, F, G, X0, X1, H>(
                this.val0, this.val1, this.val2, this.val3, this.val4, this.val5, this.val6, value0,
                value1, this.val7);
    }

    public <X0, X1> GkDecade<A, B, C, D, E, F, G, H, X0, X1> addAt8(
            final X0 value0, final X1 value1) {
        return new GkDecade<A, B, C, D, E, F, G, H, X0, X1>(
                this.val0, this.val1, this.val2, this.val3, this.val4, this.val5, this.val6,
    ...
    public <X> GkOctet<X, B, C, D, E, F, G, H> setAt0(final X value) {
        return new GkOctet<X, B, C, D, E, F, G, H>(
    ...
    public <X> GkOctet<A, X, C, D, E, F, G, H> setAt1(final X value) {
        return new GkOctet<A, X, C, D, E, F, G, H>(
    ...
    public <X> GkOctet<A, B, X, D, E, F, G, H> setAt2(final X value) {
        return new GkOctet<A, B, X, D, E, F, G, H>(
    ...
    public <X> GkOctet<A, B, C, X, E, F, G, H> setAt3(final X value) {
        return new GkOctet<A, B, C, X, E, F, G, H>(
    ...
    public <X> GkOctet<A, B, C, D, X, F, G, H> setAt4(final X value) {
        return new GkOctet<A, B, C, D, X, F, G, H>(
    ...
    public <X> GkOctet<A, B, C, D, E, X, G, H> setAt5(final X value) {
        return new GkOctet<A, B, C, D, E, X, G, H>(
    ...
    public <X> GkOctet<A, B, C, D, E, F, X, H> setAt6(final X value) {
        return new GkOctet<A, B, C, D, E, F, X, H>(
