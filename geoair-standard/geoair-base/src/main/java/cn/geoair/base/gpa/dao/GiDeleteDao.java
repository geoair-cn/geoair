...
public interface GiDeleteDao<M extends GiEntityRemovable<PK>, PK extends Serializable>
        extends GiDao<M, PK> {

    @SuppressWarnings("unchecked")
    public static <M extends GiEntityRemovable<PK>, PK extends Serializable>
            GiDeleteDao<M, PK> getDao(Class<M> modelCls) {
