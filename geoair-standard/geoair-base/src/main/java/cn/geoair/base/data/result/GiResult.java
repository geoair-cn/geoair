...
public interface GiResult<T> extends GiValuable<T> {
     ...
     * @return 当前GiResult实例
     */
    public default GiResult<T> andCode(GiResultCode code) {
     ...
     * @return 当前GiResult实例
     */
    public default GiResult<T> andAlertTypeEnum(GirEmAlertType alertTypeEnum) {
     ...
     * @return 当前GiResult实例
     */
    public default GiResult<T> forSuccessAlertMsg(String msg) {
     ...
     * @return 当前GiResult实例
     */
    public default GiResult<T> forFailureAlertMsg(String msg) {
     ...
     * @return 当前GiResult实例
     */
    public default GiResult<T> forFailureSetCodeAndMsgAndType(
            int code, String msg, GirEmAlertType alertType) {
     ...
     * @return GiResult<K> 失败状态的结果对象
     */
    public static <K> GiResult<K> failureSetCodeAndMsgAndType(
            int code, String msg, GirEmAlertType alertType) {
