...
public class GirTypeModelKid<ID extends Serializable> extends GirModelKid<ID>
        implements GiTypeModelable<ID> {
    ...
    public static <ID extends Serializable> GirTypeModelKid<ID> valueWith(
            GirModelTypeKid modelTypeKid, ID id) {
        return new GirTypeModelKid<ID>(modelTypeKid, id);
    }

    public static <ID extends Serializable> Collection<GirTypeModelKid<?>> valuesWith(
            GirModelTypeKid modelTypeKid, Set<ID> ids) {
