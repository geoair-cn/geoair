...
public interface GiUpdateDao<M extends GiEntityAlterable<PK>, PK extends Serializable>
        extends GiDao<M, PK> {

    @SuppressWarnings("unchecked")
    public static <M extends GiEntityAlterable<PK>, PK extends Serializable>
            GiUpdateDao<M, PK> getDao(Class<M> modelCls) {
