...
public class GirOrder<T> implements Serializable {
    ...
    /**
     * Creates a new {@link GirOrder} instance. Takes a single property. Direction is {@link
     * Direction#ASC} and NullHandling {@link NullHandling#NATIVE}.
     *
     * @param property must not be {@literal null} or empty.
     */
    ...
    /**
     * Creates a new {@link GirOrder} instance. Takes a single property. Direction is {@link
     * Direction#DESC} and NullHandling {@link NullHandling#NATIVE}.
     *
     * @param property must not be {@literal null} or empty.
     */
     ...
     * @return
     */
    public GirOrder<T> with(Direction direction) {
     ...
     * @return
     */
    public GirOrder<T> with(NullHandling nullHandling) {
