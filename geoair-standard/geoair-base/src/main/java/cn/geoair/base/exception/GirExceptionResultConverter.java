...
public abstract class GirExceptionResultConverter {
    ...
    private static final Map<Class<? extends Exception>, Integer> primitiveExceptionCodeMap =
            new IdentityHashMap<Class<? extends Exception>, Integer>(8);
    ...
    static {
        ...
        primitiveExceptionAlertTypeMap.put(
                GirValidateException.class, GirEmAlertType.无需关闭的提示1.value());
    }
