...
public class GirSimpleExampleParser {
     ...
     * @return GkPair<String, List<Object>> key 是 sql value 是 值 （sql 里面使用 预编译 ？ 占位）
     */
    public GkPair<String, List<Object>> updateByExampleSelective(
            Object updateEntity, GirExample girExample) {
        List<Object> objects = new ArrayList<>();
        StringBuilder sql = new StringBuilder();
        // 安全更新，Example 必须包含条件
        SqlHelper.exampleHasAtLeastOneCriteriaCheck(girExample);
     ...
     * @return GkPair<String, List<Object>> key 是 sql value 是 值 （sql 里面使用 预编译 ？ 占位）
     */
    public GkPair<String, List<Object>> updateByExample(
            Object updateEntity, GirExample girExample) {
        List<Object> objects = new ArrayList<>();
        StringBuilder sql = new StringBuilder();
        // 安全更新，Example 必须包含条件
    ...
    private String updateSetColumns(
            Object updateEntity, GirExample girExample, List<Object> objects, boolean notNull) {
        // 这里判断是否为json类型
