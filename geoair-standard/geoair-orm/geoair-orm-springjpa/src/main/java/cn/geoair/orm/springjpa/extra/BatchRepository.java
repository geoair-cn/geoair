...
/**
 * @author ：zhangjun
 * @date ：Created in 2022/10/25 16:33 @description： 批量操作相关的 存储仓库
 */
public interface BatchRepository<T extends GiEntityable<PK>, PK extends Serializable> {
    ...
    default <S extends T> Iterable<S> batchSave(Iterable<S> collect) {
        ...
        // .getFieldValue(this, gtcReflectionUtil.findField(
        // gtcAopUtil.getTargetClass(this.getClass()), "em", EntityManager.class));
