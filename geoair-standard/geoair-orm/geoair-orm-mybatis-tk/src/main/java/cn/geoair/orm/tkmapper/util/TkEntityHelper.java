package cn.geoair.orm.tkmapper.util;
...
public class TkEntityHelper {
    ...
    private static final Map<String, EntityColumn> entityTableMap =
            new GkConcurrentReferenceHashMap<String, EntityColumn>();
     ...
     * @return
     */
    public static EntityColumn getEntityColumnByMethodName(
            Class<?> entityClass, String methodName) {

        return entityTableMap.computeIfAbsent(
                methodName,
                key -> {
                    ...
                    for (EntityColumn column : table.getEntityClassColumns()) {
                        ...
                        try {
                            ...
                            Gir.log.error(
                                    e, "tk.mybatis.mapper.entity.EntityField类无法访问 getter setter属性");
                        }
                    }
                    return null;
                });
