...
public interface GiLogger {
     ...
     * <p>
     * 建议在构造复杂的日志消息前调用此方法进行判断，以避免不必要的性能开销
     *
     ...
     * 记录错误（ERROR）级别的日志
     * <p>
     * ERROR 级别表示错误事件，可能不影响应用程序继续运行但需要被关注
     *
     * @param format    日志消息格式字符串，支持 {@code {}} 作为占位符
     * @param arguments 格式化参数，用于替换消息中的占位符
     */
     ...
     * 记录警告（WARN）级别的日志
     * <p>
     * WARN 级别表示潜在的错误情况或非预期的事件，但应用程序仍可正常运行
     *
     * @param format    日志消息格式字符串，支持 {@code {}} 作为占位符
     * @param arguments 格式化参数，用于替换消息中的占位符
     */
     ...
     * 记录信息（INFO）级别的日志
     * <p>
     * INFO 级别表示应用程序运行过程中的重要事件，用于了解系统的整体运行状态
     *
     * @param format    日志消息格式字符串，支持 {@code {}} 作为占位符
     * @param arguments 格式化参数，用于替换消息中的占位符
     */
     ...
     * 记录调试（DEBUG）级别的日志
     * <p>
     * DEBUG 级别用于记录对调试应用程序有帮助的详细信息，通常在开发环境中启用
     *
     * @param format    日志消息格式字符串，支持 {@code {}} 作为占位符
     * @param arguments 格式化参数，用于替换消息中的占位符
     */
     ...
     * 记录追踪（TRACE）级别的日志
     * <p>
     * TRACE 是最详细的日志级别，用于记录程序的细粒度执行流程，通常在问题排查时使用
     *
     * @param format    日志消息格式字符串，支持 {@code {}} 作为占位符
     * @param arguments 格式化参数，用于替换消息中的占位符
     */
