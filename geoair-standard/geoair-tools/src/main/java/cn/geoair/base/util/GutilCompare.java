...
public class GutilCompare {
     ...
     * @return 中文比较器
     * @since 5.4.3
     *     <p>public static <T> Comparator<T> comparingPinyin(Function<T, String> keyExtractor) {
     ...
     * @since 5.4.3
     *     <p>public static <T> Comparator<T> comparingPinyin(Function<T, String> keyExtractor,
     *     boolean reverse) { Objects.requireNonNull(keyExtractor); PinyinComparator
     *     pinyinComparator = new PinyinComparator(); if (reverse) { return (o1, o2) ->
     *     pinyinComparator.compare(keyExtractor.apply(o2), keyExtractor.apply(o1)); } return (o1,
     *     o2) -> pinyinComparator.compare(keyExtractor.apply(o1), keyExtractor.apply(o2)); }
     */
}
