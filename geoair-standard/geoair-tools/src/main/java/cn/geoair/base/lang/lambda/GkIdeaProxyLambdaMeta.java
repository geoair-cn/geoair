...
public class GkIdeaProxyLambdaMeta implements GkfLambdaMeta {
    ...
    static {
        try {
            ...
            FIELD_MEMBER_NAME =
                    GutilReflection.setAccessible(
                            classDirectMethodHandle.getDeclaredField("member"));
            Class<?> classMemberName = Class.forName("java.lang.invoke.MemberName");
            FIELD_MEMBER_NAME_CLAZZ =
                    GutilReflection.setAccessible(classMemberName.getDeclaredField("clazz"));
            FIELD_MEMBER_NAME_NAME =
                    GutilReflection.setAccessible(classMemberName.getDeclaredField("name"));
    ...
    public GkIdeaProxyLambdaMeta(Proxy func) {
        ...
        try {
            Object dmh =
                    GutilReflection.setAccessible(handler.getClass().getDeclaredField("val$target"))
                            .get(handler);
