...
public class GkSnowflake implements Serializable {
     ...
     *
     * <p>public Snowflake() { this(IdUtil.getWorkerId(IdUtil.getDataCenterId(MAX_DATA_CENTER_ID),
     * MAX_WORKER_ID)); }
     */
    /**
     * 构造
     *
     * @param workerId 终端ID
     *     <p>public Snowflake(long workerId) { this(workerId,
    ...
    private long checkBetween(long value, long min, long max) {
        if (value < min || value > max) {
            throw new IllegalArgumentException(
                    GutilStr.format("The value must be between {} and {}.", min, max));
        }
        return value;
    }
