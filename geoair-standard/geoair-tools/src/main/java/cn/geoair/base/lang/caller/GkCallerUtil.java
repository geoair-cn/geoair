...
public class GkCallerUtil {
     ...
     * @return 调用此方法的方法名
     *     <p>public static String getCallerMethodName2(boolean isFullName){ final StackTraceElement
     *     stackTraceElement = Thread.currentThread().getStackTrace()[2]; final String methodName =
     *     stackTraceElement.getMethodName(); if(false == isFullName){ return methodName; }
     *     <p>return stackTraceElement.getClassName() + "." + methodName; }
     */
    /**
