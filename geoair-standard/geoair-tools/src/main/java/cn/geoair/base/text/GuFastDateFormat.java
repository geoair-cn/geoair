...
public class GuFastDateFormat extends Format {
     ...
     */
    public static synchronized GuFastDateFormat getInstance(
     ...
     * @throws IllegalArgumentException if the Locale has no date pattern defined
     */
    public static synchronized GuFastDateFormat getDateInstance(
            int style, TimeZone timeZone, Locale locale) {
     ...
     * @throws IllegalArgumentException if the Locale has no time pattern defined
     */
    public static synchronized GuFastDateFormat getTimeInstance(
            int style, TimeZone timeZone, Locale locale) {
        Object key = Integer.valueOf(style);
        if (timeZone != null) {
            key = new Pair(key, timeZone);
     ...
     * @since 2.1
     */
    public static GuFastDateFormat getDateTimeInstance(
     ...
     * @throws IllegalArgumentException if the Locale has no date/time pattern defined
     */
    public static synchronized GuFastDateFormat getDateTimeInstance(
     ...
     */
    static synchronized String getTimeZoneDisplay(
            TimeZone tz, boolean daylight, int style, Locale locale) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            switch (c) {
                ...
                case 'z': // time zone (text)
                    if (tokenLen >= 4) {
                        rule =
                                new TimeZoneNameRule(
                                        mTimeZone, mTimeZoneForced, mLocale, TimeZone.LONG);
                    } else {
                        rule =
                                new TimeZoneNameRule(
                                        mTimeZone, mTimeZoneForced, mLocale, TimeZone.SHORT);
                    }
                    break;
     ...
     *
     * <p>This zone is always used for <code>Date</code> formatting. If a <code>Calendar</code> is
     * passed in to be formatted, the time zone on that may be used depending on {@link
    ...
    /**
     * Returns <code>true</code> if the time zone of the calendar overrides the time zone of the
     * formatter.
     *
        ...
        public final void appendTo(StringBuffer buffer, int value) {
            if (value < 100) {
                ...
                if (value < 1000) {
                    ...
                    GutilAssert.isTrue(
                            value > -1, "Negative values should not be possible" + value);
    ...
    private static class TwelveHourField implements NumberRule {
        ...
        /**
         * Constructs an instance of <code>TwelveHourField</code> with the specified <code>
         * NumberRule</code>.
         *
         * @param rule the rule
         */
    ...
    private static class TwentyFourHourField implements NumberRule {
        ...
        /**
         * Constructs an instance of <code>TwentyFourHourField</code> with the specified <code>
         * NumberRule</code>.
         *
         * @param rule the rule
         */
    ...
    private static class TimeZoneNameRule implements Rule {
         ...
         * @param timeZoneForced if <code>true</code> the time zone is forced into standard and
         *     daylight
    ...
    /**
     * Inner class to output a time zone as a number <code>+/-HHMM</code> or <code>+/-HH:MM</code>.
     */
     ...
     *
     * <p>One use for this class is to create a hashtable key out of multiple objects.
     */
