...
public abstract class GutilAssert {
    ...
    /**
     * Assert a boolean expression, throwing an {@code gtcDataValidationException} if the expression
     * evaluates to {@code false}.
     *
     * <p>Call {@link #isTrue} if you wish to throw an {@code gtcDataValidationException} on an
     * assertion failure.
     *
     * <pre class=
     * "code">
    ...
    /**
     * as of 4.3.7, in favor of {@link #state(boolean, String)} public static void state(boolean
     * expression) { state(expression, "[Assertion failed] - this state invariant must be true"); }
     */
    ...
    public static void equal(Object object1, Object object2, String message) {
        if (GutilObject.notEqual(object1, object2)) {
            throw new IllegalStateException(nullSafeGet(() -> message));
        }
    }

    public static void equalString(String string1, String string2, String message) {
        if (GutilObject.notEqual(string1, string2)) {
            throw new IllegalStateException(nullSafeGet(() -> message));
        }
    }
     ...
     * @param messageSupplier a supplier for the exception message to use if the assertion fails
     * @throws gtcDataValidationException if the object array is {@code null} or contains no
     *     elements
     * @since 5.0
     */
     ...
     * @param messageSupplier a supplier for the exception message to use if the assertion fails
     * @throws gtcDataValidationException if the collection is {@code null} or contains no elements
     * @since 5.0
     */
