...
public class GutilArray extends PrimitiveArrayUtil {
     ...
     * @return 数组
     * @since 3.0.9
     *     <p>public static <T> T[] toArray(Iterator<T> iterator, Class<T> componentType) { return
     *     toArray(CollUtil.newArrayList(iterator), componentType); }
     */
     ...
     * @return 数组
     * @since 3.0.9
     *     <p>public static <T> T[] toArray(Iterable<T> iterable, Class<T> componentType) { return
     *     toArray(CollUtil.toCollection(iterable), componentType); }
     */
