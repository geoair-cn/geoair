 ...
 * 响应体上下文工具类。
 *
 * <p>基于 ThreadLocal 实现，用于在请求处理过程中手动设置响应体内容， 供日志采集器在 Filter 中获取。
 *
 * <p>使用场景：
 *
 * <ul>
 *   <li>在 Controller/Service 中设置业务响应内容
 *   <li>在 Filter 中采集响应体用于日志记录
 *   <li>解决响应体无法重复读取的问题
 * </ul>
 */
public class ResponseBodyContext {
     ...
     * 设置响应体内容（字节数组形式）。
     *
     * <p>适用于二进制响应（如文件下载），但二进制内容不会记录到日志中， 只会记录大小。
     *
     * @param body 响应体字节数组
     */
