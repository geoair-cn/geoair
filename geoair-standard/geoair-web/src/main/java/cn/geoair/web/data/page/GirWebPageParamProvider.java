...
public class GirWebPageParamProvider implements GiPageParamProvider {
	...
	public GiPageParam getPageParam() {
		...
		String startKey = GirPropertyHelper.getPropertier().getProperty("gir.data.page.param.start", "start");
		String pageKey = GirPropertyHelper.getPropertier().getProperty("gir.data.page.param.page", "page");
		String limitKey = GirPropertyHelper.getPropertier().getProperty("gir.data.page.param.limit", "limit");
		...
		if (limit != null && GutilStr.isInteger(limit)) {
			...
			pageSize = GirPropertyHelper.getPropertier().getProperty("gir.data.page.param.pageSize", Integer.class, 25);
		}
