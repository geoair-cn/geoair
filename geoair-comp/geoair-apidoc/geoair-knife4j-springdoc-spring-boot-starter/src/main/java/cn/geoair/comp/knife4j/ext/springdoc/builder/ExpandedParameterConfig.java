...
//
//    @Bean
//    public ParameterCustomizer expandedParameterCustomizer(ObjectMapperProvider objectMapperProvider) {
...
//                    List<Parameter> expandedParams = (List<Parameter>) param.getExtensions().get("expandedParams");
