...
public class GtcKnife4jDemoApplication {

    public static void main(String[] args) {
        SpringApplication.run(GtcKnife4jDemoApplication.class, args);
        // 是否启用swagger 在
        // 启动后访问 localhost:port/doc   即可看到接口文档页面
        // 注意 springBoot 2.4.0 以上的版本，application.yml配置文件中的 matching-strategy 要修改成ant_path_matcher
