...
// @Order(1)
// @Primary
// public class GaModelFieldBuilderBack extends ApiModelPropertyPropertyBuilder {
//
//
// public GaModelFieldBuilderBack(DescriptionResolver descriptions,
...
// AnnotationUtils.getAnnotation(context.getAnnotatedElement().get(),
...
// context.getSpecificationBuilder().enumerationFacet(e -> new
// AllowableListValues(enumValues, "LIST"));
//
// } catch (Exception e) {
// e.printStackTrace();
// }
