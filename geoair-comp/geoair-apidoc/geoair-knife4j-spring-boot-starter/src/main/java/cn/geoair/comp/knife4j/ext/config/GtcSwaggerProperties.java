 ...
 * 包含基础开关、文档信息、自动组装（包扫描/排除/排序）等配置
 */
@Component
...
public class GtcSwaggerProperties {
    ...
    /**
     * 控制器根包列表（支持多根包扫描）
     * 示例：["com.gtc.controller.web", "com.gtc.controller.base"]
     */
    private List<String> controllerRootPackages = new ArrayList<>();

    /**
     * 扫描时需要排除的包（支持通配符，如：com.gtc.controller.test*）
     * 示例：["com.gtc.controller.test", "com.gtc.controller.demo"]
     */
