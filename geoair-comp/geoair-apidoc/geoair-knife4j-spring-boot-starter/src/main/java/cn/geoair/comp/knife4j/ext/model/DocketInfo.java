...
/**
 * @author ：张俊
 * @date ：Created in 2022/8/23 16:14
 * @description： Docket 收集模型
 */
public class DocketInfo {
     ...
     * @param modelClassList model Class集合
     */
    public DocketInfo(String groupName, String basePackage,String specifyScan,String modelscan,List<Class> modelClassList) {
        this.groupName = groupName;
        this.basePackage = basePackage;
        this.specifyScan = specifyScan;
        this.modelscan = modelscan;
