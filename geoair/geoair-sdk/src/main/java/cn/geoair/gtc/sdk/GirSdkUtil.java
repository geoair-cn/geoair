...
import cn.geoair.gtc.sdk.body.GirMultipartBody;
import  cn.geoair.gtc.sdk.GirSdkProfileConfig.ProfileEnum;
...
public class GirSdkUtil {
	...
	private static HttpURLConnection setHeaders(HttpURLConnection conn) throws Exception {
		...
		String clientId =  GirSdkProfileConfig.getConfig( GirSdkProfileConfig.ProfileLocal.get(),  GirSdkProfileConfig.BusType_clientId);
		String clientSecret =  GirSdkProfileConfig.getConfig( GirSdkProfileConfig.ProfileLocal.get(),  GirSdkProfileConfig.BusType_clientSecret);
	...
	public static<T> T parseResult(String resString,Class<T> clazz,Type type) {
		try {
			...
			try {
				...
				String alertMsgKey =  GirSdkProfileConfig.getConfig( GirSdkProfileConfig.ProfileLocal.get(),  GirSdkProfileConfig.BusType_reslut_msgkey,"alertMsg");
	...
	public static void validate(HttpServletRequest request) throws Exception {
		...
		validateClient(request, GirSdkProfileConfig.getConfig(pe,  GirSdkProfileConfig.BusType_clientId), GirSdkProfileConfig.getConfig(pe,  GirSdkProfileConfig.BusType_clientSecret));
	}
