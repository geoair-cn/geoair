...
public class GutilAop {
	 ...
	 * <p>
	 * 此方法除了检查对象是否为代理外，还会额外检查给定对象是否为{@link Proxy}的实例。
	 * @param object 要检查的对象
	 ...
	 * 检查给定对象是否为JDK动态代理。
	 * <p>
	 * 此方法在{@link Proxy#isProxyClass(Class)}实现的基础上，额外检查给定对象是否为 的实例。
	 * @param object 要检查的对象
	 * @return 如果对象是JDK动态代理则返回true，否则返回false
	 * @see java.lang.reflect.Proxy#isProxyClass
	 */
	@GaMethodHandDefine(expectClassName = "org.springframework.aop.support.AopUtils",
