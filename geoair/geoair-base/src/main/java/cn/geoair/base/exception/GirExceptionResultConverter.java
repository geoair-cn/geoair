...
public abstract class GirExceptionResultConverter {
	...
	private static final Map<Class<? extends Exception>, Integer> primitiveExceptionCodeMap = new IdentityHashMap<Class<? extends Exception>, Integer>(
			8);
	...
	private static final Map<Class<? extends Exception>, Integer> primitiveExceptionAlertTypeMap = new IdentityHashMap<Class<? extends Exception>, Integer>(
			8);
	...
	static {
		...
		// primitiveExceptionAlertTypeMap.put( gtcNoLoginException.class,
		// GirEmAlertType.无需关闭的错误3.value());
		// primitiveExceptionAlertTypeMap.put( gtcPermissionException.class,
		// GirEmAlertType.无需关闭的提示1.value());
	...
	/*
	 * public static GiResult<IllegalArgumentException>
	 * checkDataConvert(IllegalArgumentException ex){ GiResult<IllegalArgumentException>
	 * res = GiResult.getResult(IllegalArgumentException.class);
	 * res.setAlertMsg(ex.getMessage()); res.setValue(ex); res.setCode(899);
	 * res.setAlertType( gtcEmAlertType.无需关闭的提示1.value()); return res; }
	 */
