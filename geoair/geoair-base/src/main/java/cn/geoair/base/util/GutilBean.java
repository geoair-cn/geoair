...
public class GutilBean {
	...
	@GaMethodHandDefine(id = "cn.geoair.base.util.GutilBean.copyProperties",
			expectClassName = "org.springframework.beans.BeanUtils", expectMethodName = "copyProperties")
	...
	public static boolean isSimpleValueType(Class<?> type) {
		return (Void.class != type && void.class != type
				&& (GutilClass.isPrimitiveOrWrapper(type) || Enum.class.isAssignableFrom(type)
