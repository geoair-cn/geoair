...
/**
 * <p>
 * A tuple of two elements, with positions 0 and 1 renamed as "label" and "value",
 * respectively.
 * </p>
 *
 *
 */
public final class GkLabelValue<A, B> extends GkTuple implements GkiValueLabel<A>, GkiValueValue<B> {
	...
	public static <X> GkLabelValue<X, X> fromArray(final X[] array) {
		...
		if (array.length != 2) {
			throw new IllegalArgumentException(
					"Array must have exactly 2 elements in order to create a LabelValue. Size is " + array.length);
		}
	...
	public GkLabelValue(final A label, final B value) {
		super(label, value);
		this.label = label;
		this.value = value;
	}
