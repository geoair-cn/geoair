...
public enum GemDatePattern {
	...
	NULL("", ""), ISO8601Long(GemDatePattern.Constant.ISO8601Long, "Y-m-d H:i:s"), ISO8601Short(
			GemDatePattern.Constant.ISO8601Short, "Y-m-d"), ChineseDate(GemDatePattern.Constant.ChineseDate,
					"Y年m月d日"), ShortDate(GemDatePattern.Constant.ShortDate, "n/j/Y"), LongDate(
							GemDatePattern.Constant.LongDate,
							"l, F d, Y"), FullDateTime(GemDatePattern.Constant.FullDateTime,
									"l, F d, Y g:i:s A"), MonthDay(GemDatePattern.Constant.MonthDay,
											"F d"), ShortTime(GemDatePattern.Constant.ShortTime, "g:i A"), LongTime(
													GemDatePattern.Constant.LongTime, "g:i:s A"), SortableDateTime(
															GemDatePattern.Constant.SortableDateTime,
															"Y-m-d\\TH:i:s"), UniversalSortableDateTime(
																	GemDatePattern.Constant.UniversalSortableDateTime,
																	"Y-m-d H:i:sO"), YearMonth(
																			GemDatePattern.Constant.YearMonth, "F, Y");
