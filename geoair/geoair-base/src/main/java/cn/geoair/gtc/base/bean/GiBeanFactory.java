...
public interface GiBeanFactory {
	 ...
	 * @throws GtcNoSuchBeanException 如果没有bean是这个name<br> if there is no bean with the specified name
	 * @throws GtcBeanException 如果bean不能被获得<br> if the bean could not be obtained
	 */
	Object getBean(String name) throws GtcBeanException;
	 ...
	 * @throws GtcNoSuchBeanException 找不到类型的bean抛出异常<br> if there is no such bean definition
	 * @throws GtcBeanNotOfRequiredTypeException 如果bean和类型不匹配抛出异常<br> if the bean is not of the required type
	 * @throws GtcBeanException 如果bean不能被创建<br> if the bean could not be created
	 */
	<T> T getBean(String name, Class<T> requiredType) throws GtcBeanException;
	 ...
	 * @return 相应的bean实例<br>an instance of the bean
	 * @throws GtcNoSuchBeanException 找不到类型的bean抛出异常<br> if there is no such bean definition
	 * @throws GtcBeanDefinitionStoreException 参数传递之后bean不是一个prototype类型时抛出异常<br> if arguments have been given but the affected bean isn't a prototype
	 * @throws GtcBeanException bean不能被创建抛出异常<br> if the bean could not be created
	 */
	Object getBean(String name, Object... args) throws GtcBeanException;
	 ...
	 * @throws GtcBeanException bean不能被创建抛出异常<br>if the bean could not be created
	 */
	<T> T getBean(Class<T> requiredType, Object... args) throws GtcBeanException;
	 ...
	 * @param requiredType 匹配的类或接口（不能为null）<br>the required type of the bean
	 * @return 相应的bean实例<br>an instance of the bean
	 * @throws GtcNoSuchBeanException 找不到抛出异常<br>if no bean of the required type is found
	 * @throws GtcNoUniqueBeanException 找到多个抛出异常<br>if more than one bean of the required type is found
	 * @throws GtcBeanException bean创建异常<br>if the bean could not be created
	 */
	<T> T getBean(Class<T> requiredType) throws GtcBeanException;
	 ...
	 * @throws GtcBeanException bean创建异常<br>if the bean could not be created
	 */
	<T> T getBean(Class<T> requiredType,Type[] genericType) throws GtcBeanException;
	 ...
	 * @throws GtcBeanException 如果bean不能被创建<br>if a bean could not be created
	 */
	<T> Map<String, T> getBeans(Class<T> clazz,Type[] genericType) throws GtcBeanException;
	 ...
	 * @throws GtcBeanException 如果bean不能被创建<br>if a bean could not be created
	 */
	<T> Map<String, T> getBeans(Class<T> clazz) throws GtcBeanException;
	 ...
	 * @throws GtcNoSuchBeanException 如果没有具有给定名称的bean<br>if there is no bean with the given name
	 */
	boolean isSingleton(String name) throws GtcNoSuchBeanException;
	 ...
	 * @throws GtcNoSuchBeanException 如果没有具有给定名称的bean<br>if there is no bean with the given name
	 */
	boolean isPrototype(String name) throws GtcNoSuchBeanException;
	 ...
	 * @throws GtcNoSuchBeanException  如果没有具有给定名称的bean<br> if there is no bean with the given name
	 */
	boolean isTypeMatch(String name,Class<?> typeToMatch) throws GtcNoSuchBeanException;
	 ...
	 * @throws GtcNoSuchBeanException 如果没有具有给定名称的bean<br>if there is no bean with the given name
	 */
	Class<?> getType(String name) throws GtcNoSuchBeanException;
	 ...
	 * @throws GtcBeanDefinitionStoreException 注册失败异常<br>if the registration fails
	 */
	void register(String name,Class<?> beanClass) throws GtcBeanDefinitionStoreException;
	 ...
	 * @throws GtcBeanDefinitionStoreException 注册失败异常<br>if the registration fails
	 */
	void register(String name, Class<?> beanClass,boolean singleton) throws GtcBeanDefinitionStoreException;
}
