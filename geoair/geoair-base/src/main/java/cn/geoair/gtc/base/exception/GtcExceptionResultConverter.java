...
import cn.geoair.gtc.base.data.GtcValidateException;
import cn.geoair.gtc.base.data.result.GiResult;
import cn.geoair.gtc.base.data.result.GtcEmAlertType;
//import  com.gtc.base.user. gtcNoLoginException;
//import  com.gtc.base.user.permission. gtcPermissionException;

public abstract class GtcExceptionResultConverter {
	...
	static {
		...
		primitiveExceptionCodeMap.put( GtcException.class, 998);
...
//		primitiveExceptionCodeMap.put( gtcPermissionException.class, 799);
		primitiveExceptionCodeMap.put( GtcValidateException.class, 499);
	}
	...
	static {
		primitiveExceptionAlertTypeMap.put(Exception.class,  GtcEmAlertType.不弹框0.value());
		primitiveExceptionAlertTypeMap.put( GtcException.class,  GtcEmAlertType.无需关闭的错误3.value());
...
//		primitiveExceptionAlertTypeMap.put( gtcPermissionException.class,  GtcEmAlertType.无需关闭的提示1.value());
		primitiveExceptionAlertTypeMap.put( GtcValidateException.class,  GtcEmAlertType.无需关闭的提示1.value());
	}
