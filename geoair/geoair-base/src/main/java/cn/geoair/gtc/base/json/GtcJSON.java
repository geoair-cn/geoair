...
import cn.geoair.gtc.base.lang.GkTypeReference;
...
public interface GtcJSON extends Cloneable, Serializable/*, Map<String, Object> */{
     ...
     * @return
     */
    @GaMethodHandDefine(expectClassName = "com.gtc.spi.json.Json4Gtc")
