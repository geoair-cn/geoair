...
public class GtcIdGenerator {

	static {
		GkMethodHand.implFromClass( GtcIdGenerator.class);
	}
	...
	@GaMethodHandImpl(implClass= GtcIdGenerator.class,implMethod="randomUUID",type= GaMethodHandImpl.ImplType.comity)
	...
	@GaMethodHandImpl(implClass= GtcIdGenerator.class,implMethod="simpleUUID",type= GaMethodHandImpl.ImplType.comity)
