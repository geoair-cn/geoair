...
@GaModel(text="默认返回结果")
public class GtcResult<T> implements GiResult<T> {
	...
	@GaModelField(text="提示消息类型",em =  GtcEmAlertType.class)
	...
	@Override
	public GtcResult<T> forSuccess() {
		this.andCode(200).andAlertTypeEnum( GtcEmAlertType.不弹框0);
		return this;
	}

	@Override
	public GtcResult<T> forFailure() {
		this.andAlertTypeEnum( GtcEmAlertType.不弹框0).andCode(999).andAlertTypeEnum( GtcEmAlertType.需要关闭的提示2);
		return this;
	}
