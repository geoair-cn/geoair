...
public class GirResultConfig implements GiResultConfig {
	...
	/*
	 * @Override public <T> gtcResult<T> getResult(Class<T> clazz) { return new
	 * gtcSimpleResult<T>(clazz); }
	 *
	 * @Override public <T> gtcResult<T> getSuccessResult(Class<T> clazz) { return new
	 * gtcSimpleResult<T>(clazz).forSuccess(); }
	 */
	@Override
