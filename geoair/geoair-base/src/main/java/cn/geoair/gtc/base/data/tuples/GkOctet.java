 ...
 *
 */
public final class GkOctet<A,B,C,D,E,F,G,H>
        extends GkTuple
    ...
    public static <A,B,C,D,E,F,G,H> GkOctet<A,B,C,D,E,F,G,H> with(final A value0, final B value1, final C value2, final D value3, final E value4, final F value5, final G value6, final H value7) {
    ...
    private static <X> GkOctet<X,X,X,X,X,X,X,X> fromIterable(final Iterable<X> iterable, int index, final boolean exactSize) {
