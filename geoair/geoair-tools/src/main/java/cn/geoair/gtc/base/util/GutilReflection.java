...
*/
	...
	public static void setFieldValue(Object obj, String fieldName, Object value) throws IllegalStateException {
		...
		GutilAssert.notNull(field, GutilStr.format("Field [{}] is not exist in [{}]", fieldName, obj.getClass().getName()));
	...
	public static List<Method> getPublicMethods(Class<?> clazz, Filter<Method> filter) {
		...
		if (null != filter) {
			...
			methodList =  gtcArrayUtil.newArrayList(methods);
		}
		return methodList;
	}*/
	...
	public static List<Method> getPublicMethods(Class<?> clazz, String... excludeMethodNames) {
		final HashSet<String> excludeMethodNameSet =  gtcCollectionUtil.newHashSet(excludeMethodNames);
	...
	public static <T> T newInstance(Class<T> clazz, Object... params) throws IllegalStateException {
		...
		if (null == constructor) {
			throw new IllegalStateException(GutilStr.format("No Constructor matched for parameter types: [{}]", new Object[]{paramTypes}));
		}
		try {
	...
	public static <T> T invokeWithCheck(Object obj, Method method, Object... args) throws  gtcException {
		...
		if (null != args) {
			 gtcAssert.isTrue(args.length == types.length, gtcStrUtil.format( "Params length [{}] is not fit for param length [{}] of method !", args.length, types.length));
			Class<?> type;
	...
	public static <T> T invoke(Object obj, Method method, Object... args) throws  gtcException {
		...
		if (null != args) {
			for (int i = 0; i < actualArgs.length; i++) {
				if (i >= args.length || null == args[i]) {
					// 越界或者空值
					actualArgs[i] =  gtcClassUtil.getDefaultValue(parameterTypes[i]);
		...
		try {
			return (T) method.invoke( gtcClassUtil.isStatic(method) ? null : obj, actualArgs);
		} catch (Exception e) {
	...
	public static <T> T invoke(Object obj, String methodName, Object... args) throws  gtcException {
		final Method method = getMethodOfObj(obj, methodName, args);
		if (null == method) {
			throw new  gtcException( gtcStrUtil.format("No such method: [{}]", methodName));
		}
		return invoke(obj, method, args);
	}*/
