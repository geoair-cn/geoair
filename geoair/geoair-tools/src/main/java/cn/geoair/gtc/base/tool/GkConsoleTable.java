...
import cn.geoair.gtc.base.util.GutilChar;
...
public class GkConsoleTable {
	 ...
	 * @return 自身对象
	 */
	public GkConsoleTable addHeader(String... titles) {
	 ...
	 * @return 自身对象
	 */
	public GkConsoleTable addBody(String... values) {
		List<String> l = new ArrayList<>();
		BODY_LIST.add(l);
	...
	private void fillBorder(StringBuilder sb) {
		...
		for (Integer width : columnCharNumber) {
			sb.append(GutilStr.fillAfter("", ROW_LINE, width + 2));
			sb.append(CORNER);
		}
		sb.append(LF);
	}
