package cn.geoair.gtc.base.text;
 ...
 * 来自 common lang
 */
public class GuFastDateFormat extends Format {
	 ...
	 */
	public static GuFastDateFormat getInstance() {
	 ...
	 */
	public static GuFastDateFormat getInstance(String pattern) {
	 ...
	 * @throws IllegalArgumentException if pattern is invalid
	 */
	public static GuFastDateFormat getInstance(String pattern, TimeZone timeZone) {
	 ...
	 * @throws IllegalArgumentException if pattern is invalid
	 */
	public static GuFastDateFormat getInstance(String pattern, Locale locale) {
	 ...
	 */
	public static synchronized GuFastDateFormat getInstance(String pattern, TimeZone timeZone, Locale locale) {
		GuFastDateFormat emptyFormat = new GuFastDateFormat(pattern, timeZone, locale);
		GuFastDateFormat format = (GuFastDateFormat) cInstanceCache.get(emptyFormat);
		if (format == null) {
			format = emptyFormat;
	...
	/**
	 * <p>
	 * Gets a date formatter instance using the specified style in the default time zone
	 * and locale.
	 * </p>
	 ...
	 * @since 2.1
	 */
	public static GuFastDateFormat getDateInstance(int style) {
		return getDateInstance(style, null, null);
	}

	/**
	 * <p>
	 * Gets a date formatter instance using the specified style and locale in the default
	 * time zone.
	 * </p>
	 * @param style date style: FULL, LONG, MEDIUM, or SHORT
	 * @param locale optional locale, overrides system locale
	 ...
	 * @since 2.1
	 */
	public static GuFastDateFormat getDateInstance(int style, Locale locale) {
	 ...
	 * @since 2.1
	 */
	public static GuFastDateFormat getDateInstance(int style, TimeZone timeZone) {
	...
	public static synchronized GuFastDateFormat getDateInstance(int style, TimeZone timeZone, Locale locale) {
		...
		GuFastDateFormat format = (GuFastDateFormat) cDateInstanceCache.get(key);
		if (format == null) {
			try {
	...
	/**
	 * <p>
	 * Gets a time formatter instance using the specified style in the default time zone
	 * and locale.
	 * </p>
	 ...
	 * @since 2.1
	 */
	public static GuFastDateFormat getTimeInstance(int style) {
		return getTimeInstance(style, null, null);
	}

	/**
	 * <p>
	 * Gets a time formatter instance using the specified style and locale in the default
	 * time zone.
	 * </p>
	 * @param style time style: FULL, LONG, MEDIUM, or SHORT
	 * @param locale optional locale, overrides system locale
	 ...
	 * @since 2.1
	 */
	public static GuFastDateFormat getTimeInstance(int style, Locale locale) {
	 ...
	 * @since 2.1
	 */
	public static GuFastDateFormat getTimeInstance(int style, TimeZone timeZone) {
	...
	public static synchronized GuFastDateFormat getTimeInstance(int style, TimeZone timeZone, Locale locale) {
		...
		GuFastDateFormat format = (GuFastDateFormat) cTimeInstanceCache.get(key);
		if (format == null) {
			if (locale == null) {
				locale = Locale.getDefault();
			}
	...
	/**
	 * <p>
	 * Gets a date/time formatter instance using the specified style in the default time
	 * zone and locale.
	 * </p>
	 ...
	 * @since 2.1
	 */
	public static GuFastDateFormat getDateTimeInstance(int dateStyle, int timeStyle) {
		return getDateTimeInstance(dateStyle, timeStyle, null, null);
	}

	/**
	 * <p>
	 * Gets a date/time formatter instance using the specified style and locale in the
	 * default time zone.
	 * </p>
	 * @param dateStyle date style: FULL, LONG, MEDIUM, or SHORT
	 * @param timeStyle time style: FULL, LONG, MEDIUM, or SHORT
	 ...
	 * @since 2.1
	 */
	public static GuFastDateFormat getDateTimeInstance(int dateStyle, int timeStyle, Locale locale) {
		return getDateTimeInstance(dateStyle, timeStyle, null, locale);
	}

	/**
	 * <p>
	 * Gets a date/time formatter instance using the specified style and time zone in the
	 * default locale.
	 * </p>
	 * @param dateStyle date style: FULL, LONG, MEDIUM, or SHORT
	 * @param timeStyle time style: FULL, LONG, MEDIUM, or SHORT
	 ...
	 * @since 2.1
	 */
	public static GuFastDateFormat getDateTimeInstance(int dateStyle, int timeStyle, TimeZone timeZone) {
	...
	public static synchronized GuFastDateFormat getDateTimeInstance(int dateStyle, int timeStyle, TimeZone timeZone,
		...
		GuFastDateFormat format = (GuFastDateFormat) cDateTimeInstanceCache.get(key);
		if (format == null) {
			try {
	...
	/**
	 * <p>
	 * Constructs a new gtcFastDateFormat.
	 * </p>
	 * @param pattern {@link java.text.SimpleDateFormat} compatible pattern
	 ...
	 * @throws IllegalArgumentException if pattern is invalid or <code>null</code>
	 */
	protected GuFastDateFormat(String pattern, TimeZone timeZone, Locale locale) {
		super();
		if (pattern == null) {
	 ...
	 * <code>Calendar</code> is passed in to be formatted, the time zone on that may be
	 * used depending on {@link #getTimeZoneOverridesCalendar()}.
	 * </p>
	...
	/**
	 * <p>
	 * Returns <code>true</code> if the time zone of the calendar overrides the time zone
	 * of the formatter.
	 * </p>
	 * @return <code>true</code> if time zone of formatter overridden for calendars
	 */
	...
	public boolean equals(Object obj) {
		if (obj instanceof GuFastDateFormat == false) {
			return false;
		}
		GuFastDateFormat other = (GuFastDateFormat) obj;
	...
	public String toString() {
		return " gtcFastDateFormat[" + mPattern + "]";
	}
	...
	private static class StringLiteral implements Rule {
		...
		/**
		 * Constructs a new instance of <code>StringLiteral</code> to hold the specified
		 * value.
	...
	private static class TextField implements Rule {
		...
		/**
		 * Constructs an instance of <code>TextField</code> with the specified field and
		 * values.
		...
		public final void appendTo(StringBuffer buffer, int value) {
			if (value < 100) {
				...
				if (value < 1000) {
					...
					GutilAssert.isTrue(value > -1, "Negative values should not be possible" + value);
	...
	private static class TimeZoneNameRule implements Rule {
		 ...
		 * @param timeZoneForced if <code>true</code> the time zone is forced into
