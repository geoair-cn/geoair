...
public class GtcConsoleLog implements GiLoger {


	public static GtcConsoleLog forName(String name) {
		return new GtcConsoleLog(name);
	}
	...
	/**
		 ...
		 * @param clazz 类
		 */
		public GtcConsoleLog(Class<?> clazz) {
	...
	/**
		 ...
		 * @param name 类名
		 */
		public GtcConsoleLog(String name) {
			this.name = name;
		}
