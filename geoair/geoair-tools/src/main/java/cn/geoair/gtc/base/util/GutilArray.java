	...
	// ---------------------------------------------------------------------- isEmpty
		...
		public static <T> String join(T[] array, CharSequence conjunction, String prefix, String suffix) {
			...
			for (T item : array) {
				...
				if ( gtcArrayUtil.isArray(item)) {
					sb.append(join( gtcArrayUtil.wrap(item), conjunction, prefix, suffix));
					...
					sb.append( gtcStrUtil.wrap( gtcStrUtil.toString(item), prefix, suffix));
				}
			}
			return sb.toString();
		} */
