 ...
 * @author
 */
public class GutilArray extends PrimitiveArrayUtil {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <T> T firstMatch(GkMatcher<T> matcher, T... array) {
		if (isNotEmpty(array)) {
	 ...
	 * @since 5.3.3
	 */
	public static <T> void edit(T[] array, GkEditor<T> editor) {
	 ...
	 *
	 * <pre>
	 * 1、过滤出需要的对象，{@link GkFilter#accept(Object)}方法返回true的对象将被加入结果集合中
	 * </pre>
	 * @param <T> 数组元素类型
	 * @param array 数组
	 ...
	 * @since 3.2.1
	 */
	public static <T> T[] filter(T[] array, GkFilter<T> filter) {
		if (null == filter) {
			return array;
		}
	...
	public static <T> T[] removeNull(T[] array) {
		return filter(array, (GkEditor<T>) t -> {
			// 返回null便不加入集合
			return t;
		});
	}
	...
	public static <T extends CharSequence> T[] removeEmpty(T[] array) {
		return filter(array, (GkFilter<T>) t -> false == GutilStr.isEmpty(t));
	}
	...
	public static <T extends CharSequence> T[] removeBlank(T[] array) {
		return filter(array, (GkFilter<T>) t -> false == GutilStr.isBlank(t));
	}
	...
	public static String[] nullToEmpty(String[] array) {
		return filter(array, (GkEditor<String>) t -> null == t ? GutilStr.EMPTY : t);
	}
	...
	public static <T> int indexOf(T[] array, Object value) {
		if (null != array) {
			for (int i = 0; i < array.length; i++) {
				if (GutilObject.equal(value, array[i])) {
					return i;
				}
			}
		}
	...
	public static int indexOfIgnoreCase(CharSequence[] array, CharSequence value) {
		if (null != array) {
			for (int i = 0; i < array.length; i++) {
				if (GutilStr.equalsIgnoreCase(array[i], value)) {
					return i;
				}
			}
		}
	...
	public static Object[] wrap(Object obj) {
		...
		throw new IllegalStateException(GutilStr.format("[{}] is not Array!", obj.getClass()));
	}
	 ...
	 *
	 * <pre>
	 *  gtcArrayUtil.length(null)            = 0
	 *  gtcArrayUtil.length([])              = 0
	 *  gtcArrayUtil.length([null])          = 1
	 *  gtcArrayUtil.length([true, false])   = 2
	 *  gtcArrayUtil.length([1, 2, 3])       = 3
	 *  gtcArrayUtil.length(["a", "b", "c"]) = 3
	 * </pre>
	 * @param array 数组对象
	 * @return 数组长度
	...
	public static <T> String join(T[] array, CharSequence conjunction) {
		return join(array, conjunction, null);
	}
	 ...
	 * @since 4.0.10
	 *
	 * public static <T> String join(T[] array, CharSequence conjunction, String prefix,
	 * String suffix) { if (null == array) { return null; }
	 *
	 * final StringBuilder sb = new StringBuilder(); boolean isFirst = true; for (T item :
	 ...
	 * sb.append(CollUtil.join((Iterable<?>) item, conjunction, prefix, suffix)); } else
	 * if (item instanceof Iterator<?>) { sb.append(IterUtil.join((Iterator<?>) item,
	 * conjunction, prefix, suffix)); } else { sb.append( gtcStrUtil.wrap(
	 * gtcStrUtil.toString(item), prefix, suffix)); } } return sb.toString(); }
	 */
	 ...
	 * @since 5.3.3
	 */
	public static <T> String join(T[] array, CharSequence conjunction, GkEditor<T> editor) {
		if (null == array) {
			return null;
		}
		...
		for (T item : array) {
			...
			if (null != item) {
				sb.append(GutilStr.toString(item));
			}
		}
		return sb.toString();
	}
	...
	public static String join(Object array, CharSequence conjunction) {
		if (isArray(array)) {
			...
			if (componentType.isPrimitive()) {
				...
				default:
					throw new IllegalStateException(GutilStr.format("Unknown primitive type: [{}]", componentTypeName));
				}
			}
			else {
	...
	public static <T extends Comparable<? super T>> T min(T[] numberArray, Comparator<T> comparator) {
		...
		T min = numberArray[0];
		for (T t : numberArray) {
			if (GutilCompare.compare(min, t, comparator) > 0) {
				min = t;
			}
		}
		return min;
	...
	public static <T extends Comparable<? super T>> T max(T[] numberArray, Comparator<T> comparator) {
		...
		for (int i = 1; i < numberArray.length; i++) {
			if (GutilCompare.compare(max, numberArray[i], comparator) < 0) {
				max = numberArray[i];
			}
		}
		return max;
	...
	/**
	 * 计算{@code null}或空元素对象的个数，通过{@link GutilObject#isEmpty(Object)} 判断元素
	...
	public static int emptyCount(Object... args) {
		...
		if (isNotEmpty(args)) {
			for (Object element : args) {
				if (GutilObject.isEmpty(element)) {
					count++;
				}
			}
		}
	...
	/**
	 * 是否存在{@code null}或空对象，通过{@link GutilObject#isEmpty(Object)} 判断元素
	 * @param args 被检查对象
	 * @return 是否存在
	 * @since 4.5.18
	 */
	...
	/**
	 * 是否存都为{@code null}或空对象，通过{@link GutilObject#isEmpty(Object)} 判断元素
	 * @param args 被检查的对象,一个或者多个
	 * @return 是否都为空
	 * @since 4.5.18
	 */
	...
	/**
	 * 是否存都不为{@code null}或空对象，通过{@link GutilObject#isEmpty(Object)} 判断元素
	 * @param args 被检查的对象,一个或者多个
	 * @return 是否都不为空
	 * @since 4.5.18
	 */
	...
	public static boolean equals(Object array1, Object array2) {
		...
		GutilAssert.isTrue(isArray(array1), "First is not a Array !");
		GutilAssert.isTrue(isArray(array2), "Second is not a Array !");
