...
import cn.geoair.gtc.orm.tkmapper.page.TkGithubPageHelper;
...
public interface TkPagerMapper<M extends GiEntityQueryable<PK>, PK extends Serializable> extends GiPagerDao<M, PK> {
	 ...
	 * gtcSelectDao.<M,PK>getDao(modelClass); gtcPager<M> pager = this.get
	 * gtcPager(modelClass); gtcPageExcute<M> exec = new gtcPageExcute<M>() {
	 * @Override public gtcPager<M> get gtcPager(){ return pager; }
	 * @Override public List<M> excute() { return selectDao.selectByPKs(keys); }};
	 *
