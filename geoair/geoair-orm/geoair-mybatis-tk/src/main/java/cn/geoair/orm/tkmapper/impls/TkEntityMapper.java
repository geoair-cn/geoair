...
public interface TkEntityMapper<T extends GiCrudEntity<PK>, PK extends Serializable>
		extends TkInsertMapper<T, PK>, TkDeleteMapper<T, PK>, TkUpdateMapper<T, PK>, TkRetrieveMapper<T, PK>,
		TkPagerMapper<T, PK>, MyBatisMapper<T, PK>/* ,MySqlMapper<T>,IdsMapper<T> */ {
