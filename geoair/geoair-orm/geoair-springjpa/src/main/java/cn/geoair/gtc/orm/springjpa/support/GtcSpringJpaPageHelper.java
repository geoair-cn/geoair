package cn.geoair.gtc.orm.springjpa.support;
 ...
 */
public class GtcSpringJpaPageHelper implements GiPageExcuter {

	/**
	 * 从 gtcSort对象拼装 Spring Data Jpa Sort
	 * @param sort
	 * @return
	 */

	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static Sort sortFromgtcSort( GtcSort sort) {
		...
		if(sort != null) {
        	...
        	while(iterator.hasNext()) {
        		...
        		if(order.getPropertyFun() != null) {
        			...
        			if(order.getDirection() ==  GtcOrder.Direction.DESC) {
	...
	/**
	 * 从 gtcPageParam 转换 Spring Data Jpa Pageable (spring data jpa 的页码从0开始)
	 * @param pageParam
	 * @return
	 */
