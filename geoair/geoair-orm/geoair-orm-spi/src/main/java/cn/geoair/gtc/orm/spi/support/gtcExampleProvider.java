...
//     * @return
//     */
//    public Pair<String, List<Object>> updateByExampleSelective(T updateEntity,  gtcExample  gtcExample) {
//        List<Object> objects = new ArrayList<>();
//        StringBuilder sql = new StringBuilder();
//        //安全更新，Example 必须包含条件
//        SqlHelper.exampleHasAtLeastOneCriteriaCheck( gtcExample);
...
//     * @return
//     */
//    public Pair<String, List<Object>> updateByExample(T updateEntity,  gtcExample  gtcExample) {
//        List<Object> objects = new ArrayList<>();
//        StringBuilder sql = new StringBuilder();
//        //安全更新，Example 必须包含条件
//        SqlHelper.exampleHasAtLeastOneCriteriaCheck( gtcExample);
...
//
//
//    private String updateSetColumns(T updateEntity,  gtcExample  gtcExample, List<Object> objects, boolean notNull) {
//        // 这里判断是否为json类型
...
//                updatesql.append(column.getColumn()).append(" = ").append(column.getColumn()).append(",");
//            }
//        }
