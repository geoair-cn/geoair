...
public class GirJpaSimpleExampleExecutor implements GirExampleExecutor {
    ...
    @Resource EntityManagerProvider entityManagerProvider;
    ...
    @Override
    public <E> GiPager<E> selectPageByExample(
            E type, GirExample girExample, GiPageParam pageParam) {
    ...
    public Integer updateByExample(Object updateEntity, GirExample girExample) {
        GkPair<String, List<Object>> pair =
                girSimpleExampleParser.updateByExample(updateEntity, girExample);
        String key = pair.getValue0();
