 ...
 * @author zhangjun
 */
public class GtcJpaGirEntityResolve implements GirEntityResolve {

    private final GiLogger log =  GirLogger.getLoger( GtcJpaGirEntityResolve.class);
    ...
    protected void processField(GtcEntityTable gtcEntityTable, GtcEntityField field) {
        ...
        if (columnName == null || columnName.equals("")) {
            String entityTableField =  Gir.beans.getBean(EntityManagerProvider.class).getEntityTableField( gtcEntityTable.getEntityClass(), field.getName());
