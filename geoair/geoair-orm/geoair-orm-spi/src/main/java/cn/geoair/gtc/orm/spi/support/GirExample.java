...
//        }
        ...
        public GirExample build() {
            ...
            for ( GirSqls.Criteria criteria : sqlsCriteria) {
                 GirExample.Criteria exampleCriteria = new  GirExample.Criteria(this.propertyMap, this.exists, this.notNull);
        ...
        private void transformCriterion(GirExample.Criteria exampleCriteria, String condition, String property, Object[] values, String andOr) {
            if (values.length == 0) {
                if ("and".equals(andOr)) {
