...
//import  com.gtc.orm.spi.support. gtcEntityHelper;
//
...
//     * 实体类 => 表对象
//     */
//    private static final Map<String,  gtcEntityTable> entityTableMap = new ConcurrentHashMap();
//
//
//    /**
//     * 实体类解析器
...
//        if ( gtcEntityTable == null) {
//            throw new RuntimeException("无法通过该解析器" + dynamictableresolve.getClass().getName() + "获取实体对象!");
//        } else {
