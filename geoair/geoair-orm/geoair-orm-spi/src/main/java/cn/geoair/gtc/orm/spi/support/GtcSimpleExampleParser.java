 ...
 */
public class GtcSimpleExampleParser {
     ...
     */
    public GkPair<String, List<Object>> selectCountByExample(GtcExample gtcExample) {
        ...
        sql.append(SqlHelper.exampleWhereClause( gtcExample, objects).getValue0());
     ...
     * @return GkPair<String, List<Object>>  key 是 sql  value 是 值 （sql 里面使用 预编译 ？ 占位）
     */
    public GkPair<String, List<Object>> deleteByExample( GtcExample gtcExample) {
     ...
     * @return GkPair<String, List<Object>>  key 是 sql  value 是 值 （sql 里面使用 预编译 ？ 占位）
     */
    public GkPair<String, List<Object>> selectByExample( GtcExample gtcExample) {
     ...
     * @return GkPair<String, List<Object>>  key 是 sql  value 是 值 （sql 里面使用 预编译 ？ 占位）
     */
    public GkPair<String, List<Object>> selectByExampleAndRowBounds( GtcExample gtcExample) {
     ...
     * @return GkPair<String, List<Object>>  key 是 sql  value 是 值 （sql 里面使用 预编译 ？ 占位）
     */
    public GkPair<String, List<Object>> updateByExampleSelective(Object updateEntity,  GtcExample gtcExample) {
        List<Object> objects = new ArrayList<>();
        StringBuilder sql = new StringBuilder();
        //安全更新，Example 必须包含条件
        SqlHelper.exampleHasAtLeastOneCriteriaCheck( gtcExample);
        ...
        sql.append(SqlHelper.updateByExampleWhereClause( gtcExample, objects).getValue0());
        return new GkPair<>(sql.toString(), objects);
    }
     ...
     * @return GkPair<String, List<Object>>  key 是 sql  value 是 值 （sql 里面使用 预编译 ？ 占位）
     */
    public GkPair<String, List<Object>> updateByExample(Object updateEntity,  GtcExample gtcExample) {
        List<Object> objects = new ArrayList<>();
        StringBuilder sql = new StringBuilder();
        //安全更新，Example 必须包含条件
        SqlHelper.exampleHasAtLeastOneCriteriaCheck( gtcExample);
    ...
    private String updateSetColumns(Object updateEntity, GtcExample gtcExample, List<Object> objects, boolean notNull) {
        // 这里判断是否为json类型

    	Map<String, Object> stringObjectMap =  GtcJSON.toJson(updateEntity).toBean(HashMap.class);

        //Map<String, Object> stringObjectMap = JSONObject.parseObject(JSONObject.toJSONString(updateEntity)).getInnerMap();
        StringBuilder sql = new StringBuilder();
        //获取全部列
        Set<GtcEntityColumn> columnSet =  GtcEntityHelper.getColumns( gtcExample.getEntityClass());
