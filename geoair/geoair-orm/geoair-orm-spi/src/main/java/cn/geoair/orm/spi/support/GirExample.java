	...
	public static class Builder {
		...
		public GirExample build() {
			...
			for (GirSqls.Criteria criteria : sqlsCriteria) {
				GirExample.Criteria exampleCriteria = new GirExample.Criteria(this.propertyMap, this.exists,
						this.notNull);
		...
		private void transformCriterion(GirExample.Criteria exampleCriteria, String condition, String property,
