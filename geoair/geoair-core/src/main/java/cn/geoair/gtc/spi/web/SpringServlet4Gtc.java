...
public class SpringServlet4Gtc {

	static {
		GkMethodHand.implFromClass(SpringServlet4Gtc.class);
	}

    @GaMethodHandImpl(implClass= GtcHttpServletHelper.class,implMethod="getRequest",type=ImplType.expectfirst)
    ...
    @GaMethodHandImpl(implClass= GtcHttpServletHelper.class,implMethod="getResponse",type=ImplType.expectfirst)
    ...
    @GaMethodHandImpl(implClass= GtcHttpServletHelper.class,implMethod="getServletContext",type=ImplType.expectfirst)
    public static ServletContext getServletContext() {

    	if(servletContextWarp.get() == null) {
    		ServletContext sc =  GtcHttpServletHelper.getRequest().getServletContext();
