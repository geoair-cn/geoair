...
public class Json4Gir {
	...
	static {
		if(GutilClass.isPresent("com.alibaba.fastjson.JSON", GirFastJson.class.getClassLoader())) {
			Json4Gir.setJsonUtilType(JsonUtilSupport.FASTJSON);
		}else if(GutilClass.isPresent("com.fasterxml.jackson.databind.ObjectMapper", GirJacksonJson.class.getClassLoader())) {
