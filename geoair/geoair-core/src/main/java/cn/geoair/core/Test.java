...
public class Test {
    ...
    public static void main2(String[] args) {
         ...
         *
         * //Gir.log.info(Long.toHexString(key));
         * //Gir.log.info(Long.toOctalString(key));
         * //Gir.log.info(Long.toBinaryString(key));
         * System.out.println(encode(key));
         * //Gir.log.info("-----------------------------------------");
         * //Gir.log.info( gtcIdGenerator.timestampId());//20221026160931974011
