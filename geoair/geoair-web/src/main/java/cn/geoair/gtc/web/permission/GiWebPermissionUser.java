...
//import  com.gtc.base.user.session.GiUserSessionConfig;
...
//		if(session != null) {
//			GiUserSessionConfig usc = GiUserSessionConfig.getUserConfig(this. gtcType(). gtcTypeUserClass(GiSessionUser.class));
...
//		GiUserSessionConfig cfg = GiUserSessionConfig.getUserConfig(this. gtcType(). gtcTypeUserClass(GiSessionUser.class));
//
